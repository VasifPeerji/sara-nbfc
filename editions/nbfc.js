  ...
  */
  ...
  kb: [
    ...
    },
    {
      ...
      tags: ["subvention", "scheme", "used CV", "dealer", "first instalment", "disbursal date", "convention", "renewal", "mandate"],
      body:
    ...
    },
    {
      ...
      tags: ["field investigation", "FI", "verification", "residence", "business", "negative", "geotag", "photograph", "evidence", "sampling"],
      body:
    ...
    },
    {
      ...
      tags: ["tele-calling", "call", "script", "recording", "promise to pay", "PTP", "disposition", "abusive", "disputed", "callback"],
      body:
    ...
    },
    {
      ...
      tags: ["repossession", "possession", "vehicle", "notice", "clause", "authorisation", "precondition", "voluntary surrender", "grievance", "release"],
      body:
    ...
    },
    {
      ...
      tags: ["yard", "custody", "inventory", "valuation", "sale", "auction", "reserve", "shortfall", "surplus", "redemption", "notice of sale"],
      body:
        ...
        "Redemption before sale. The borrower may redeem at any time before the sale by paying the amount stated in the notice. Where the borrower tenders that amount, the vehicle is released within two working days and the account is regularised. A redemption tender is not refused because a sale has been arranged but not concluded.\n\n" +
    ...
    },
    {
      ...
      tags: ["fraud", "RCU", "typology", "sampling", "investigation", "staff involvement", "identity substitution", "collusion", "reporting", "recovery"],
      body:
