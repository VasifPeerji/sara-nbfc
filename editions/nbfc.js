  ...
  journeys: [
      ...
      steps: [
        ...
        { id: "documents", type: "multi", q: "Which of these are complete and on the file?",
          ...
          options: [
            ...
            "Insurance in force with Anvira as loss payee",
      ...
      steps: [
        ...
        { id: "outstanding", type: "multi", q: "Which items are still outstanding?",
          ...
          options: [
            ...
            "Insurance policy copy with Anvira as loss payee",
            "End use evidence",
        ...
        { id: "severity", type: "check", q: "Which of these change the security position",
          rules: [
            ...
            { label: "Insurance copy on file", of: "outstanding",
              test: "includes", value: "Insurance policy copy with Anvira as loss payee",
        ...
        { id: "eligible", type: "check", q: "What must be established first",
          rules: [
            ...
            { label: "Not an operational failure being collected on", of: "cause",
              ...
              fail: "Collecting on a delinquency Anvira created is the most expensive mistake available in this function" },
          ] },
      ],
      produce: {
...

    {
        ...
        { id: "actions", type: "check", q: "What follows from this",
          rules: [
            ...
            { label: "Unapplied receipts investigated within two working days",
              ...
              fail: "An unapplied receipt is money the customer has paid and Anvira has not recognised, producing a delinquency that is not real" },
      ...
      produce: {
        ...
        footer: "Where an account is delinquent for a reason within Anvira's control, it is corrected rather than collected.",
      },
    },
...

    {
      ...
      steps: [
        ...
        { id: "noticeGiven", type: "confirm", q: "Was prior notice of the auction given, stating date and place?",
          optional: true, when: { stage: "Sold" }, cite: "CR-009" },
        { id: "didNotBid", type: "confirm", q: "Confirm Anvira did not participate in the auction",
          optional: true, when: { stage: "Sold" }, cite: "CR-009" },
        { id: "conduct", type: "check", q: "What the procedure requires",
          rules: [
            ...
            { label: "Anvira did not participate in the auction", of: "didNotBid",
              test: "truthy", cite: "CR-009", when: { stage: "Sold" }, na: "Not at auction stage",
              fail: "Anvira does not bid on the auction of its own pledged ornaments" },
          ] },
      ],
      produce: {
        ...
        footer: "Where release is delayed beyond seven working days for a reason attributable to Anvira, compensation is payable at the rate in the pricing circular for each day of delay, and the delay is reported as an incident.",
      },
    },
    ...
    /* ========== CUSTOMER AND CHANGE ========== */
    {
      ...
      steps: [
        ...
        { id: "received", type: "date", q: "Date first received anywhere in Anvira?",
          cite: "GP-005",
...

    {
      ...
      steps: [
        ...
        { id: "entities", type: "multi", q: "Which entities does it bind?",
          cite: "CM-004",
          options: ["Anvira Finserv Limited", "Anvira Housing Finance Limited", "Anvira Microfinance Limited"] },
