...
window.SARA_EDITION = {
  ...
  company: {
    name: "Kritanya Finserv Limited",
    short: "Kritanya",
    domain: "kritanyafinserv.com",
    ...
    about:
      "Kritanya Finserv Limited is a diversified non-banking financial company registered with the Reserve Bank of " +
      ...
      "issue financing. Housing is written through Kritanya Housing Finance Limited, an HFC regulated by the Reserve " +
      "Bank and supervised alongside the National Housing Bank framework, and joint liability group lending through " +
      "Kritanya Microfinance Limited, an NBFC-MFI. Distribution runs through 1,180 branches, roughly 4,300 direct " +
      "sourcing agents, 2,100 dealer counters, a business correspondent network and four digital lending apps " +
      "operated with six lending service providers. Kritanya is not a deposit taking company. Its equity is unlisted " +
  ...
  login: {
    ...
    sub: "Ask in plain language. Sara answers from Kritanya's own credit policy, product notes, procedures, circulars and operating records, and shows you the controlled document behind every claim, with its revision.",
    ...
    legal: "SARA is an internal Kritanya system. It prepares, computes and drafts. It does not authorise: sanction, disbursal, deviation approval, enforcement, waiver, write-off and regulatory filing remain the act of the delegated authority.",
  },
  ...
  */
  guardrails: [
    ...
    "Obligations differ by entity and by product. Kritanya is an NBFC-ICC; Kritanya Housing Finance is an HFC and Kritanya Microfinance is an NBFC-MFI, and each carries different classification, pricing, documentation and reporting duties. Never state an obligation, threshold or timeframe without naming the entity and the product it belongs to and the document it comes from. If the person has not said which, ask before answering.",

    "Do not give legal, tax, accounting or investment advice. Summarise what Kritanya's own policies say, state plainly where they stop, and route the decision to Legal, Finance, the Compliance Officer or the relevant external adviser.",
  ],
  ...
  mcp: [
    { name: "Loan Management",   url: "https://mcp.kritanyafinserv.com/lms",        transport: "HTTP", tools: 9, status: "connected" },
    { name: "Loan Origination",  url: "https://mcp.kritanyafinserv.com/los",        transport: "HTTP", tools: 6, status: "connected" },
    { name: "Collections",       url: "https://mcp.kritanyafinserv.com/collections", transport: "HTTP", tools: 5, status: "connected" },
    { name: "Compliance Gateway", url: "https://mcp.kritanyafinserv.com/compliance", transport: "HTTP", tools: 4, status: "connected" },
  ],
  ...
  analytics: {
    level: "full",
    identify: "required",
    /* This is a whole-sector build and the tenant is invented, so the
       identify gate must not tell the reader it was prepared for them
       or for anybody they have heard of. */
    audience: "sector",
    sectorLabel: "non-banking financial company sector",
    disclose: false,
  ...
  */
  roles: [
    ...
    },
    {
      ...
      clearance: 1,
      scopes: ["product"],
      focus: "Sits at a commercial vehicle dealership in Nagpur and originates finance for vehicles sold on the floor. Employed by the dealer, not by Kritanya.",
      persona: "An external partner at a dealer counter with a buyer waiting to drive away. Give the scheme terms and the document list plainly. This person does not work for Kritanya, so never disclose internal policy reasoning, credit thresholds, deviation authority or anything about another customer. Where the answer depends on internal policy, give the outcome and name the Kritanya contact.",
      ...
      prompts: [
        ...
        { t: "Who do I call at Kritanya?", s: "Escalation route", q: "A file is stuck at the credit stage. Who at Kritanya do I contact and what do they need from me?", icon: "users" },
      ],
    },
    {
      key: "dsa_principal",
      ...
      clearance: 1,
      scopes: ["policy", "product"],
      focus: "Runs a loan agency in Pune with eleven staff, sourcing loan against property and business loans for four lenders including Kritanya.",
      ...
      prompts: [
        { t: "What are my team's conduct obligations?", s: "Sourcing conduct", q: "What conduct rules apply to my staff when they collect documents and talk to customers on Kritanya's behalf?", icon: "shield" },
    ...
    },
    {
      ...
      focus: "Serves twenty-two joint liability groups across four villages in Bihar for Kritanya Microfinance. Conducts centre meetings, collects instalments in cash and remits the same day.",
    ...
    },
    {
      ...
      focus: "The named escalation point for customer grievances across the group. Represents Kritanya before external redress forums and owns the complaints reporting that goes to the board and the regulator.",
  ...
  */
  journeys: [
    ...
    {
      id: "securities_cover",
      title: "Securities cover, margin call and invocation",
      tagline: "Daily cover against the approved list, the shortfall, and the cure deadline",
      icon: "trendup",
      for: ["capmkt_ops", "central_ops", "portfolio_risk", "cro", "cco"],
      triggers: ["margin call", "securities cover", "loan against shares", "pledge invocation",
                 "cover shortfall", "margin trade funding", "top up the margin"],
      doneTitle: "Cover position worked out",
      doneNote: "The call, the shortfall and the cure deadline are in the workspace. Invocation is authorised by the Head of Capital Markets Lending, not by the desk.",
      steps: [
        { id: "client", type: "text", q: "Client name or account?" },
        { id: "facility", type: "choice", q: "Which facility?",
          options: ["Loan against shares", "Loan against mutual fund units", "Margin trade funding",
                    "Employee stock option financing", "Public issue financing"], cite: "CR-010" },
        { id: "outstanding", type: "number", q: "Outstanding including accrued interest?" },
        { id: "holdings", type: "table", q: "Pledged holdings at today's close",
          cite: "CP-001",
          help: "Only securities on the approved list count. Anything under a surveillance measure is valued at nil.",
          columns: [
            { key: "security", label: "Security" },
            { key: "qty", label: "Quantity", kind: "number" },
            { key: "price", label: "Close price", kind: "money" },
            { key: "value", label: "Value", kind: "money" },
          ] },
        { id: "portfolioValue", type: "number", q: "Total value of eligible pledged securities?",
          cite: "CP-001", help: "The sum of the value column above, excluding anything not on the approved list." },
        { id: "requiredPct", type: "number", q: "Required cover, per cent?",
          cite: "CR-010", help: "From the risk circular for this facility type." },
        { id: "callDate", type: "date", q: "Date of this valuation?" },
        { id: "position", type: "calc", q: "Cover and shortfall",
          compute: {
            lines: [
              { label: "Outstanding including accrued interest", op: "value", from: "outstanding",
                as: "O", cite: "CR-010" },
              { label: "Value of eligible pledged securities", op: "value", from: "portfolioValue",
                as: "V", cite: "CP-001" },
              { label: "Cover achieved", op: "ratio", part: "portfolioValue", whole: "outstanding",
                as: "COV", unit: "percent", cite: "CR-010" },
              { label: "Value required at the covenanted level", op: "percent", of: "outstanding",
                pct: "requiredPct", as: "REQ", cite: "CR-010" },
              { label: "Shortfall to be cured", op: "subtract", of: ["REQ", "V"], as: "SHORT",
                cite: "CP-001",
                note: "Cure by paying down the facility or pledging additional approved securities" },
            ],
            total: { label: "Shortfall", of: ["SHORT"] },
          } },
        { id: "approved", type: "confirm", q: "Are all pledged securities on the approved list?", cite: "CR-010" },
        { id: "corpAction", type: "confirm", q: "Has the corporate action calendar been checked?", cite: "CP-001" },
        { id: "amountStated", type: "confirm", q: "Does the call state the shortfall as an amount?", cite: "CP-001" },
        { id: "eligibility", type: "check", q: "Before a call is issued",
          rules: [
            { label: "Every pledged security is on the approved list", of: "approved",
              test: "truthy", cite: "CR-010",
              fail: "A security not on the list is valued at nil, which changes the shortfall" },
            { label: "Corporate action calendar checked for the cure period", of: "corpAction",
              test: "truthy", cite: "CP-001",
              fail: "A record date inside the cure period affects both the valuation and the ability to sell" },
            { label: "Call states the shortfall as an amount, not a percentage", of: "amountStated",
              test: "truthy", cite: "CP-001",
              fail: "A call stating a percentage is not actionable by the client and is not a call" },
          ] },
        { id: "cure", type: "clock", q: "The cure deadline",
          clocks: [
            { label: "Cover must be restored by", from: "callDate", every: 2, unit: "days",
              owner: "Capital Markets Lending desk",
              consequence: "The pledge is invoked and securities are sold to restore cover, beginning with the most liquid holding",
              cite: "CP-001" },
          ] },
      ],
      produce: {
        kind: "Margin call",
        title: "Margin call on {client}",
        meta: [
          { k: "Client", from: "client" }, { k: "Facility", from: "facility" },
          { k: "Valuation date", from: "callDate" }, { k: "Required cover", from: "requiredPct" },
        ],
        sections: [
          { h: "Cover position", fromStep: "position" },
          { h: "Pledged holdings", fromTable: "holdings" },
          { h: "Before this call is issued", fromStep: "eligibility" },
          { h: "Cure deadline", fromStep: "cure" },
          { h: "If cover is not restored", fromDoc: "CP-001", para: 6 },
        ],
        halt: {
          kind: "Call not issued",
          title: "Margin call withheld on {client}",
          intro: "The cover position cannot be relied on until the following are settled. Issuing a call on a valuation that includes an ineligible security produces a shortfall figure the client can dispute.",
          route: "Settle the outstanding items and rerun. Refer questions on the approved list to Risk.",
        },
        footer: "Invocation is authorised by the Head of Capital Markets Lending with the Chief Risk Officer informed. It is never a desk decision.",
      },
    },
    ...
    {
      id: "predisbursal_qc",
      title: "Pre-disbursal file quality check",
      tagline: "Everything that must be complete before money leaves, and who clears what is not",
      icon: "checklist",
      for: ["loan_ops", "central_ops", "credit_manager", "cpa", "branch_manager"],
      triggers: ["pre disbursal check", "can this file disburse", "disbursal checklist",
                 "ready for disbursement", "file quality check", "disbursal memo"],
      doneTitle: "File assessed",
      doneNote: "The disbursal memorandum or the hold list is in the workspace, with the authority required for each open item.",
      steps: [
        { id: "account", type: "text", q: "Application or account number?" },
        { id: "product", type: "choice", q: "Which product?",
          options: ["Loan against property", "Business loan", "Personal loan", "Commercial vehicle",
                    "Two-wheeler", "Gold loan"], cite: "PR-010" },
        { id: "sanctionFile", type: "file", q: "Attach the sanction letter, and I will read it",
          optional: true, cite: "OP-001",
          accept: ["pdf", "docx"],
          fields: [
            { key: "fAccount", label: "Account number", match: ["Account (?:Number|No\\.?):?\\s*([A-Z0-9-]+)", "Application (?:Number|No\\.?):?\\s*([A-Z0-9-]+)"] },
            { key: "fAmount", label: "Sanctioned amount", match: "Sanction(?:ed)? Amount:?\\s*(?:Rs\\.?|INR|₹)?\\s*([\\d,]+)" },
            { key: "fRate", label: "Rate of interest", match: "Rate of Interest:?\\s*([\\d.]+)" },
            { key: "fTenor", label: "Tenor", match: "Tenor:?\\s*(\\d+)" },
          ] },
        { id: "documents", type: "multi", q: "Which of these are complete and on the file?",
          cite: "OP-001",
          options: [
            "Loan agreement executed by every applicant and guarantor",
            "Correctly stamped for the state of execution",
            "Key facts statement issued and acknowledgement retained",
            "Identification and address complete for every applicant",
            "Repayment mandate registered and confirmed active",
            "Insurance in force with Kritanya as loss payee",
            "Valuation within validity",
            "Title clear, or the qualification cleared to the required level",
            "Disbursal account verified as the borrower's own",
          ] },
        { id: "deviations", type: "table", q: "Deviations this file carries", optional: true,
          cite: "OP-001",
          columns: [
            { key: "code", label: "Deviation" },
            { key: "norm", label: "Norm" },
            { key: "actual", label: "Actual" },
            { key: "authority", label: "Approving authority" },
          ] },
        { id: "devCount", type: "number", q: "How many deviations does the file carry?",
          cite: "OP-001",
          help: "Two deviations escalate one level above the higher. Three or more go to the Chief Credit Officer." },
        { id: "allApproved", type: "confirm", q: "Is every deviation approved by the named authority, with none pending?",
          cite: "OP-001" },
        { id: "mandateGap", type: "number", q: "Days between disbursal and the first instalment?",
          cite: "OP-001",
          help: "Check this against the mandate registration lead time for the customer's bank before releasing." },
        { id: "gate", type: "check", q: "Whether this file can disburse",
          rules: [
            { label: "Agreement executed and correctly stamped", of: "documents",
              test: "includes", value: "Correctly stamped for the state of execution", cite: "OP-002",
              fail: "A stamping defect affects admissibility and generally cannot be cured later" },
            { label: "Key facts statement acknowledged", of: "documents",
              test: "includes", value: "Key facts statement issued and acknowledgement retained", cite: "PR-005",
              fail: "A file without the acknowledgement is not disbursement-ready" },
            { label: "Mandate registered and confirmed active", of: "documents",
              test: "includes", value: "Repayment mandate registered and confirmed active", cite: "OP-003",
              fail: "Releasing against a mandate still in registration leaves the first instalment uncollectable" },
            { label: "Disbursal account verified as the borrower's own", of: "documents",
              test: "includes", value: "Disbursal account verified as the borrower's own", cite: "OP-001" },
            { label: "Every deviation approved, none pending", of: "allApproved",
              test: "truthy", cite: "OP-001",
              fail: "A file may not be disbursed while a deviation is recorded as pending" },
            { label: "First instalment interval checked against the mandate lead time",
              of: "mandateGap", test: "gte", value: 10, cite: "OP-003", blocking: false,
              fail: "The interval is short. Confirm the lead time for the customer's sponsor bank before releasing" },
          ] },
      ],
      produce: {
        kind: "Disbursal assessment",
        title: "Pre-disbursal assessment of {account}",
        meta: [
          { k: "Application", from: "account" }, { k: "Product", from: "product" },
          { k: "Deviations", from: "devCount" },
        ],
        sections: [
          { h: "Whether this file can disburse", fromStep: "gate" },
          { h: "Deviations carried", fromTable: "deviations" },
          { h: "The checklist this was assessed against", fromDoc: "OP-001", para: 1 },
          { h: "Condition precedent, or post-disbursement document", fromDoc: "OP-001", para: 2 },
        ],
        halt: {
          kind: "Disbursal hold",
          title: "Disbursal held on {account}",
          intro: "This file cannot be released. The items below are conditions precedent, not post-disbursement documents, and reclassifying one to release a file is a control breach.",
          route: "Clear the items and run this again. Where a deviation is pending, it goes to the authority named in the deviation matrix, not to the branch.",
        },
        footer: "Disbursal is released by a second person of at least the grade specified in the delegation, who re-verifies this checklist rather than confirming that it was ticked.",
      },
    },

    {
      id: "pdd_tracking",
      title: "Post-disbursement document tracking",
      tagline: "What is outstanding, against which clock, and what it actually costs us",
      icon: "clock",
      for: ["pdd_officer", "central_ops", "loan_ops", "branch_manager", "internal_auditor"],
      triggers: ["pdd", "post disbursement documents", "registration certificate outstanding",
                 "hypothecation endorsement", "pdd ageing", "documents pending after disbursal"],
      doneTitle: "Position established",
      doneNote: "The outstanding items, their clocks and the escalation are in the workspace.",
      steps: [
        { id: "account", type: "text", q: "Which account?" },
        { id: "product", type: "choice", q: "Which product?",
          options: ["Commercial vehicle", "Car", "Two-wheeler", "Loan against property", "Home loan (HFC)"],
          cite: "OP-004" },
        { id: "disbursedOn", type: "date", q: "Date of first disbursal?", cite: "OP-004" },
        { id: "deliveredOn", type: "date", q: "Date the asset was delivered?",
          optional: true, cite: "OP-007",
          when: { product: ["Commercial vehicle", "Car", "Two-wheeler"] } },
        { id: "outstanding", type: "multi", q: "Which items are still outstanding?",
          cite: "OP-004",
          options: [
            "Registration certificate with the hypothecation endorsement",
            "Registered mortgage",
            "Security interest filed with the registry",
            "Insurance policy copy with Kritanya as loss payee",
            "End use evidence",
            "Occupancy or completion certificate",
          ] },
        { id: "reason", type: "choice", q: "Why is the main item outstanding?",
          cite: "OP-007",
          options: [
            { v: "Held by dealer", t: "Issued but held by the dealer", d: "The largest single cause" },
            { v: "Not collected", t: "Issued but the borrower has not collected it" },
            { v: "Not applied", t: "The endorsement was applied for without the signed form" },
            { v: "Not issued", t: "The authority has not issued it" },
            { v: "Unknown", t: "Not established" },
          ] },
        { id: "clocks", type: "clock", q: "The clocks on these items",
          clocks: [
            { label: "Registration certificate with hypothecation endorsement",
              from: "deliveredOn", every: 60, unit: "days", owner: "Documentation and PDD Officer",
              consequence: "Until received, the exposure is unsecured in substance whatever the security flag says",
              cite: "OP-007" },
            { label: "Registered mortgage", from: "disbursedOn", every: 30, unit: "days",
              owner: "Central Operations",
              consequence: "An unregistered charge may be unenforceable against other creditors",
              cite: "OP-004" },
            { label: "Security interest filed with the registry", from: "disbursedOn", every: 30, unit: "days",
              owner: "Central Operations",
              consequence: "Late filing does not automatically restore priority",
              cite: "OP-006" },
            { label: "Insurance policy copy", from: "disbursedOn", every: 30, unit: "days",
              owner: "Branch", consequence: "An uninsured financed asset is an uncovered exposure",
              cite: "OP-004" },
          ] },
        { id: "severity", type: "check", q: "Which of these change the security position",
          rules: [
            { label: "Endorsement of hypothecation received", of: "outstanding",
              test: "includes", value: "Registration certificate with the hypothecation endorsement",
              cite: "OP-007",
              fail: "Outstanding. Until it is received the exposure is unsecured in substance",
              pass: "Received" },
            { label: "Registered mortgage complete", of: "outstanding",
              test: "includes", value: "Registered mortgage", cite: "OP-004",
              fail: "Outstanding. This leaves the exposure effectively unsecured" },
            { label: "Registry filing made", of: "outstanding",
              test: "includes", value: "Security interest filed with the registry", cite: "OP-006",
              fail: "Outstanding. Priority against other creditors is not established" },
            { label: "Insurance copy on file", of: "outstanding",
              test: "includes", value: "Insurance policy copy with Kritanya as loss payee",
              cite: "OP-004", blocking: false },
          ],
          halt: false },
      ],
      produce: {
        kind: "Ageing and escalation note",
        title: "Outstanding documents on {account}",
        meta: [
          { k: "Account", from: "account" }, { k: "Product", from: "product" },
          { k: "First disbursal", from: "disbursedOn" }, { k: "Cause", from: "reason" },
        ],
        sections: [
          { h: "Clocks on the outstanding items", fromStep: "clocks" },
          { h: "Which of these change the security position", fromStep: "severity",
            body: "Not every outstanding document matters equally, and treating them as one list is why the ageing report is ignored." },
          { h: "Escalation", fromDoc: "OP-004", para: 3 },
          { h: "Sourcing accountability", fromDoc: "OP-004", para: 4 },
        ],
        footer: "An item is closed when the document is received, verified against the requirement and imaged. A receipt entry without the document imaged is not closure.",
      },
    },

    /* ========== DECIDE AND CONTROL ========== */
    {
      id: "deviation_routing",
      title: "Deviation and exception routing",
      tagline: "Which authority clears what, and which combinations are not delegable at all",
      icon: "checklist",
      for: ["credit_manager", "rcm", "branch_manager", "cco"],
      triggers: ["deviation approval", "who can approve this deviation", "exception routing",
                 "delegation matrix", "undelegable", "credit authority"],
      doneTitle: "Routing established",
      doneNote: "The approving authority for each deviation and the compensating controls are in the workspace.",
      steps: [
        { id: "account", type: "text", q: "Application number?" },
        { id: "exposure", type: "number", q: "Total exposure to this borrower and group?",
          cite: "GP-003", help: "The whole exposure, not this facility alone. Splitting is a control breach." },
        { id: "secured", type: "choice", q: "Is the facility secured?",
          options: ["Retail secured", "Retail unsecured", "Wholesale"], cite: "GP-003" },
        { id: "devTypes", type: "multi", q: "Which deviations does the file carry?",
          cite: "CR-002",
          options: [
            "Loan to value above the norm",
            "Fixed obligation to income ratio above the norm",
            "Bureau score below the product floor",
            "Current overdue above 30 days on a live facility",
            "Written-off or settled account in the last 36 months",
            "Income assessment departure",
            "Title or valuation qualification",
            "Borrower or related party is an employee or connected to a service provider",
          ] },
        { id: "devCount", type: "number", q: "How many deviations in total?", cite: "CR-002" },
        { id: "controls", type: "multi", q: "What compensating controls are proposed?",
          optional: true, cite: "CR-002",
          options: [
            "Additional collateral",
            "Reduced tenor",
            "Co-applicant with independent income",
            "Larger own contribution",
            "Escrow of receivables",
            "Shorter first review date",
            "None proposed",
          ] },
        { id: "routing", type: "check", q: "How this routes",
          rules: [
            { label: "Single deviation, within the hub's authority", of: "devCount",
              test: "lte", value: 1, cite: "CR-002", blocking: false,
              pass: "Credit Manager may approve, subject to the individual level for that deviation",
              fail: "More than one deviation: the authority is one level above the higher of the two" },
            { label: "Three or more deviations", of: "devCount", test: "lt", value: 3,
              cite: "CR-002", blocking: false,
              pass: "Below the Chief Credit Officer threshold",
              fail: "Three or more deviations go to the Chief Credit Officer regardless of the individual levels" },
            { label: "No undelegable combination present", of: "devTypes",
              test: "notIncludes", value: "Borrower or related party is an employee or connected to a service provider",
              cite: "CR-002",
              fail: "Not delegable at any level. This goes to the Credit Committee" },
            { label: "A compensating control is proposed, not a higher rate", of: "controls",
              test: "notIncludes", value: "None proposed", cite: "CR-002", blocking: false,
              fail: "A higher rate of interest is pricing, not a compensating control" },
          ],
          halt: false },
      ],
      produce: {
        kind: "Deviation routing note",
        title: "Deviation routing for {account}",
        meta: [
          { k: "Application", from: "account" }, { k: "Exposure", from: "exposure" },
          { k: "Category", from: "secured" }, { k: "Deviations", from: "devCount" },
        ],
        sections: [
          { h: "How this routes", fromStep: "routing" },
          { h: "How combinations escalate", fromDoc: "CR-002", para: 3 },
          { h: "Not delegable at any level", fromDoc: "CR-002", para: 4 },
          { h: "What a compensating control is", fromDoc: "CR-002", para: 5 },
        ],
        footer: "Every deviation is recorded against a code with the norm, the actual, the rationale, the compensating control and the approving authority as an individual, not an office.",
      },
    },

    /* THE ONE THAT REFUSES TO FINISH.
       Every other task produces a document. This one is built to stop. A
       wrongful repossession is among the most expensive single errors a
       secured lender can make, and every collections head has authorised
       one they later regretted. The check that matters most is the first:
       the possession clause is verified against the agreement actually
       executed on this account, not against the current template. */
    {
      id: "repossession_gate",
      title: "Repossession go or no-go",
      tagline: "Every precondition tested before anyone is sent, and it stops if one fails",
      icon: "truck",
      for: ["repo_coordinator", "acm", "head_collections", "legal_recovery", "branch_manager"],
      triggers: ["can this vehicle be repossessed", "repossession preconditions", "repossession go no go",
                 "take possession of the vehicle", "seize the vehicle", "repossession authorisation"],
      doneTitle: "Position established",
      doneNote: "The authorisation checklist is in the workspace. Possession is authorised in writing by the Area Collections Manager, not by this record.",
      steps: [
        { id: "account", type: "text", q: "Which loan account?" },
        { id: "vehicle", type: "text", q: "Registration number of the vehicle?" },
        { id: "agreementDate", type: "date", q: "Date the loan agreement was executed?",
          cite: "GP-004",
          help: "Older templates do not all carry the possession clause. This is verified against the executed agreement on the file." },
        { id: "clause", type: "confirm", q: "Does the executed agreement carry the possession clause?",
          cite: "GP-004",
          yes: "Yes, verified on the executed copy", no: "No, or the executed copy cannot be located",
          help: "Verify against the executed agreement itself, not the current template." },
        { id: "dpdDays", type: "number", q: "Days past due on the account?", cite: "CO-007" },
        { id: "noticeServed", type: "confirm", q: "Has the demand notice been served and the cure period expired?",
          cite: "CO-007", yes: "Yes, with evidence of service on file", no: "Not yet" },
        { id: "grievance", type: "confirm", q: "Is any grievance or dispute open on this account?",
          cite: "CO-007", yes: "Yes, one is open", no: "No, nothing open" },
        { id: "agentRegistered", type: "confirm", q: "Is the assigned agent on the deployment register with a valid authorisation?",
          cite: "CO-004", yes: "Yes, registered and authorised", no: "No, or not confirmed" },
        { id: "exclusion", type: "confirm", q: "Is the account clear of the daily exclusion file?",
          cite: "CO-002", yes: "Yes, checked today", no: "Not checked, or it is listed" },
        { id: "gate", type: "check", q: "The six preconditions",
          rules: [
            { label: "The executed agreement carries the possession clause",
              of: "clause", test: "truthy", cite: "GP-004",
              pass: "Verified on the executed copy",
              fail: "Possession is not taken on any facility whose executed agreement does not carry the clause, whatever the arrears position. This goes to Legal." },
            { label: "Arrears meet the threshold in the product note",
              of: "dpdDays", test: "gte", value: 90, cite: "CO-007",
              fail: "Below the threshold at which possession may be considered" },
            { label: "Demand notice served and the cure period expired",
              of: "noticeServed", test: "truthy", cite: "CO-007",
              fail: "Service is the fact most often disputed and the one most often poorly evidenced" },
            { label: "No grievance or dispute open on the account",
              of: "grievance", test: "falsy", cite: "CO-007",
              fail: "A grievance is open. Recovery steps on the disputed arrears are suspended until it is resolved" },
            { label: "Agent on the deployment register with a valid authorisation",
              of: "agentRegistered", test: "truthy", cite: "CO-004",
              fail: "An account contacted by a person not on the register is an unauthorised contact whatever the outcome" },
            { label: "Account not on the exclusion file",
              of: "exclusion", test: "truthy", cite: "CO-002",
              fail: "The exclusion file is published daily and allocation runs after it is applied, not before" },
          ] },
      ],
      produce: {
        kind: "Repossession authorisation checklist",
        title: "Repossession checklist for {vehicle} on {account}",
        meta: [
          { k: "Account", from: "account" }, { k: "Vehicle", from: "vehicle" },
          { k: "Agreement executed", from: "agreementDate" }, { k: "Days past due", from: "dpdDays" },
        ],
        sections: [
          { h: "The six preconditions", fromStep: "gate" },
          { h: "What the code requires of the clause", fromDoc: "GP-004", para: 6 },
          { h: "At the point of possession", fromDoc: "CO-007", para: 5 },
          { h: "Notice after possession", fromDoc: "CO-007", para: 6 },
        ],
        halt: {
          kind: "Repossession not authorised",
          title: "Repossession NOT authorised on {vehicle}",
          intro: "This account does not meet the preconditions and no possession may be taken. Possession taken without one of them is a conversion, and the consequences are the return of the vehicle, compensation, a complaint on the record and a finding at the next inspection.",
          route: "Where the executed agreement does not carry the possession clause, or the executed copy cannot be located, the matter goes to Legal and no possession is taken pending advice, whatever the arrears. Where a grievance is open, it is resolved by the Grievance Redressal Officer before recovery steps resume.",
        },
        footer: "This checklist is not the authorisation. Possession is authorised in writing by the Area Collections Manager for the territory, naming the account, the vehicle, the agent and a validity period. A blanket or standing authorisation is not valid.",
      },
    },

    {
      id: "resolution_choice",
      title: "Restructure, settle or write off",
      tagline: "Which is available here, and what each one does to classification and the credit record",
      icon: "route",
      for: ["acm", "head_collections", "rcm", "legal_recovery", "cro", "central_ops"],
      triggers: ["restructure or settle", "one time settlement", "write off this account",
                 "resolution options", "ots", "compromise settlement"],
      doneTitle: "Options set out",
      doneNote: "Each option with its consequence is in the workspace. None of them is approved by this record.",
      steps: [
        { id: "borrower", type: "text", q: "Borrower name?" },
        { id: "account", type: "text", q: "Which facility?" },
        { id: "dues", type: "number", q: "Total contracted dues including interest and charges?" },
        { id: "recoverable", type: "number", q: "Realistically recoverable amount?" },
        { id: "securityValue", type: "number", q: "Realisable value of the security, if any?", optional: true },
        { id: "cause", type: "choice", q: "Why is this account in arrears?",
          cite: "CO-001",
          options: [
            { v: "Inability", t: "Inability to pay", d: "Circumstances have changed materially" },
            { v: "Unwillingness", t: "Unwillingness to pay", d: "Capacity exists" },
            { v: "Operational", t: "An operational failure of ours", d: "Mandate, receipt or charge" },
            { v: "Disputed", t: "The debt itself is disputed" },
          ] },
        { id: "fraudFlag", type: "confirm", q: "Is there any indication of fraud on this account?",
          cite: "CO-009", yes: "Yes, or under investigation", no: "No indication" },
        { id: "arrearsReal", type: "confirm", q: "Have unapplied receipts, mandate failures and disputed charges been ruled out?",
          cite: "CO-009", yes: "Yes, the arrears are genuine", no: "Not yet established" },
        { id: "sacrifice", type: "calc", q: "What a settlement would cost",
          compute: {
            lines: [
              { label: "Total contracted dues", op: "value", from: "dues", as: "D", cite: "CO-009" },
              { label: "Realistically recoverable", op: "value", from: "recoverable", as: "R", cite: "CO-009" },
              { label: "Sacrifice", op: "subtract", of: ["D", "R"], as: "SAC", cite: "GP-003",
                note: "Computed against the full contracted dues, and shown in the approval note rather than summarised" },
              { label: "Realisable security", op: "value", from: "securityValue", as: "SEC", cite: "CO-009",
                note: "Considered before any settlement is offered" },
            ],
            total: { label: "Sacrifice on settlement", of: ["SAC"] },
          } },
        { id: "eligible", type: "check", q: "What must be established first",
          rules: [
            { label: "The arrears are genuine", of: "arrearsReal", test: "truthy", cite: "CO-009",
              fail: "Where the arrears arise from an unapplied receipt, an unregistered mandate or a disputed charge, the account is corrected rather than settled" },
            { label: "No indication of fraud", of: "fraudFlag", test: "falsy", cite: "CO-009",
              fail: "A settlement is not available on an account under fraud investigation" },
            { label: "Security position assessed", of: "securityValue", test: "present",
              cite: "CO-009", blocking: false,
              fail: "Any realisable security is considered before a settlement is offered" },
            { label: "Not an operational failure being collected on", of: "cause",
              test: "notEquals", value: "Operational", cite: "CO-001",
              fail: "Collecting on a delinquency Kritanya created is the most expensive mistake available in this function" },
          ] },
      ],
      produce: {
        kind: "Resolution options note",
        title: "Resolution options for {borrower}",
        meta: [
          { k: "Borrower", from: "borrower" }, { k: "Facility", from: "account" },
          { k: "Contracted dues", from: "dues" }, { k: "Cause", from: "cause" },
        ],
        sections: [
          { h: "What a settlement would cost", fromStep: "sacrifice" },
          { h: "What must be established first", fromStep: "eligible" },
          { h: "Settlement and the credit record", fromDoc: "CO-009", para: 5 },
          { h: "A write-off is a different act", fromDoc: "CO-010", para: 1 },
        ],
        halt: {
          kind: "Resolution not available",
          title: "Resolution options withheld for {borrower}",
          intro: "None of the resolution options may be offered on this account until the following are settled.",
          route: "Where the arrears are not genuine, refer to Central Operations for correction. Where fraud is indicated, refer to the risk containment unit and do not negotiate.",
        },
        footer: "A settlement and a write-off are different acts with different consequences and are never recorded interchangeably. Neither is approved by this record.",
      },
    },
    ...
    {
      id: "colending_recon",
      title: "Co-lending reconciliation",
      tagline: "Two systems, one loan, and where the retention floor has quietly slipped",
      icon: "grid",
      for: ["central_ops", "reporting_analyst", "portfolio_risk", "treasury_analyst", "cro", "cfo"],
      triggers: ["co-lending reconciliation", "partner reconciliation", "retention floor",
                 "blended rate", "escrow instruction", "colending break"],
      doneTitle: "Break report prepared",
      doneNote: "The breaks, the retention position and the escrow instruction are in the workspace.",
      steps: [
        { id: "partner", type: "choice", q: "Which arrangement?",
          cite: "DG-002",
          options: ["Partner A, secured retail", "Partner B, business loans",
                    "Partner C, vehicle finance", "Partner D, affordable housing"] },
        { id: "period", type: "text", q: "Reconciliation period?", placeholder: "July 2026" },
        { id: "ourShare", type: "number", q: "Our share of the arrangement, per cent?", cite: "DG-001" },
        { id: "loans", type: "table", q: "Loans where the two records differ",
          cite: "DG-002",
          columns: [
            { key: "loan", label: "Loan" },
            { key: "oursOs", label: "Our outstanding", kind: "money" },
            { key: "theirsOs", label: "Their outstanding", kind: "money" },
            { key: "oursShare", label: "Our share %", kind: "number" },
            { key: "rate", label: "Blended rate", kind: "number" },
          ] },
        { id: "belowFloor", type: "number", q: "How many loans show our share below 10 per cent?",
          cite: "DG-001",
          help: "The floor applies loan by loan and continuously, not as an average and not only at origination." },
        { id: "prepayRule", type: "choice", q: "How are part-prepayments applied in our system?",
          cite: "DG-002",
          options: [
            { v: "Pro rata", t: "Pro rata to both shares", d: "What the agreements provide" },
            { v: "Ours first", t: "Against our share first", d: "Retention falls faster than the partner's" },
            { v: "Theirs first", t: "Against the partner's share first" },
            { v: "Unknown", t: "Not established" },
          ] },
        { id: "rateMatches", type: "confirm", q: "Does the blended rate still match what was disclosed to the borrower?",
          cite: "DG-001", yes: "Yes, it matches", no: "No, it has drifted" },
        { id: "integrity", type: "check", q: "The arrangement's own conditions",
          rules: [
            { label: "Retention at or above the floor on every loan",
              of: "belowFloor", test: "lte", value: 0, cite: "DG-001",
              fail: "A share below the floor at any point in the life of the loan is a breach of the arrangement" },
            { label: "Part-prepayments applied as the agreement provides",
              of: "prepayRule", test: "equals", value: "Pro rata", cite: "DG-002",
              fail: "Applied otherwise, the two records of the same loan diverge and retention slips without anybody deciding to" },
            { label: "Blended rate matches what the borrower was told",
              of: "rateMatches", test: "truthy", cite: "DG-001",
              fail: "A blended rate disclosed at sanction that no longer matches the arrangement is a disclosure failure, whether the borrower is paying more or less" },
          ] },
      ],
      produce: {
        kind: "Reconciliation break report",
        title: "Co-lending reconciliation, {partner}, {period}",
        meta: [
          { k: "Arrangement", from: "partner" }, { k: "Period", from: "period" },
          { k: "Our share", from: "ourShare" }, { k: "Loans below the floor", from: "belowFloor" },
        ],
        sections: [
          { h: "Loans where the records differ", fromTable: "loans" },
          { h: "The arrangement's own conditions", fromStep: "integrity" },
          { h: "How the floor is lost without anybody deciding to lose it", fromDoc: "DG-001", para: 3 },
          { h: "Break handling", fromDoc: "DG-002", para: 6 },
        ],
        halt: {
          kind: "Reconciliation exception",
          title: "Co-lending exception, {partner}, {period}",
          intro: "This arrangement is not operating within its own conditions. The position below is reported as an exception rather than as a routine break report.",
          route: "A break arising from a difference in how the two systems apply a rule is escalated immediately regardless of value, because the value grows with every subsequent transaction and the population is larger than the break that surfaced.",
        },
        footer: "Two institutions holding different records of the same loan is the recognised failure mode of this product. Reconciliation is the control that catches it before the borrower does.",
      },
    },

    {
      id: "mandate_recon",
      title: "Mandate, bounce and receipt reconciliation",
      tagline: "Which dishonours are actually defaults, and which are ours",
      icon: "refresh",
      /* This is an operations reconciliation, not a portfolio analysis, and
         it reads procedures a clearance 1 role does not hold. Portfolio Risk
         reads the outcome; Central Operations runs it. */
      for: ["central_ops", "acm", "branch_manager"],
      triggers: ["bounce reconciliation", "return reason codes", "unapplied receipts",
                 "mandate failures", "dishonour charges levied", "nach reconciliation"],
      doneTitle: "Position established",
      doneNote: "The split by return reason, the charges to reverse and the receipts to apply are in the workspace.",
      steps: [
        { id: "scope", type: "text", q: "Which population?", placeholder: "Used CV, West region, July 2026" },
        { id: "presented", type: "number", q: "Instalments presented in the period?" },
        { id: "returned", type: "number", q: "Instalments returned unpaid?" },
        { id: "codes", type: "table", q: "Returns by reason code",
          cite: "OP-003",
          columns: [
            { key: "code", label: "Return reason" },
            { key: "count", label: "Count", kind: "number" },
            { key: "borrowerDefault", label: "Borrower default?" },
          ] },
        { id: "notDefault", type: "number", q: "How many carry a reason that is not a borrower default?",
          cite: "OP-003",
          help: "Mandate not registered, mandate cancelled, or a technical failure. These are not defaults." },
        { id: "chargesLevied", type: "number", q: "Dishonour charges levied on those?",
          cite: "PR-002",
          help: "Where the dishonour was not from insufficiency of funds, no charge is levied and any charge applied is reversed." },
        { id: "unapplied", type: "number", q: "Unapplied receipts against this population?", cite: "OP-005" },
        { id: "impact", type: "calc", q: "What this actually costs",
          compute: {
            lines: [
              { label: "Instalments presented", op: "value", from: "presented", as: "P", unit: "number", cite: "OP-003" },
              { label: "Returned unpaid", op: "value", from: "returned", as: "R", unit: "number", cite: "OP-003" },
              { label: "Return rate", op: "ratio", part: "returned", whole: "presented", as: "RATE",
                unit: "percent", cite: "RK-007" },
              { label: "Not borrower defaults", op: "value", from: "notDefault", as: "ND",
                unit: "number", cite: "OP-003",
                note: "Excluded from behavioural scoring and from collections allocation" },
              { label: "Charges to be reversed", op: "value", from: "chargesLevied", as: "CH", cite: "PR-002" },
              { label: "Receipts to be applied", op: "value", from: "unapplied", as: "UA", cite: "OP-005" },
            ],
            total: { label: "To be reversed or applied", of: ["CH", "UA"] },
          } },
        { id: "actions", type: "check", q: "What follows from this",
          rules: [
            { label: "Charges on non-default returns reversed", of: "chargesLevied",
              test: "lte", value: 0, cite: "PR-002",
              fail: "Reverse them without the customer having to ask, and report it as an incident rather than a routine waiver" },
            { label: "Unapplied receipts investigated within two working days",
              of: "unapplied", test: "lte", value: 0, cite: "OP-005",
              fail: "An unapplied receipt is money the customer has paid and Kritanya has not recognised, producing a delinquency that is not real" },
            { label: "Non-default returns excluded from collections allocation",
              of: "notDefault", test: "lte", value: 0, cite: "CO-002", blocking: false,
              fail: "These accounts should be on the exclusion file, not allocated to field contact" },
          ] },
      ],
      produce: {
        kind: "Reconciliation note",
        title: "Mandate and receipt reconciliation, {scope}",
        meta: [
          { k: "Population", from: "scope" }, { k: "Presented", from: "presented" },
          { k: "Returned", from: "returned" }, { k: "Not defaults", from: "notDefault" },
        ],
        sections: [
          { h: "What this actually costs", fromStep: "impact" },
          { h: "Returns by reason code", fromTable: "codes" },
          { h: "What follows from this", fromStep: "actions" },
          { h: "Which returns are not defaults", fromDoc: "OP-003", para: 6 },
        ],
        halt: {
          kind: "Correction required",
          title: "Corrections outstanding on {scope}",
          intro: "This population carries charges and receipts that must be corrected before any collections action continues on it.",
          route: "Reverse the charges, apply the receipts, and add the affected accounts to the exclusion file so allocation does not pick them up in the meantime.",
        },
        footer: "Where an account is delinquent for a reason within Kritanya's control, it is corrected rather than collected.",
      },
    },

    /* ========== IDENTIFICATION AND GOLD ========== */
    {
      id: "kyc_validation",
      title: "Customer identification pack validation",
      tagline: "Whether the pack is acceptable, and whether it is ready for the registry",
      icon: "user",
      ...
      steps: [
        { id: "customer", type: "text", q: "Customer name?" },
        { id: "custType", type: "choice", q: "What kind of customer?",
          options: ["Individual", "Sole proprietorship", "Partnership", "Company", "Trust or society"],
          cite: "OP-011" },
        { id: "relationshipStart", type: "date", q: "Date the account based relationship commenced?",
          cite: "OP-011", help: "The registry upload window runs from this date." },
        { id: "documents", type: "multi", q: "Which of these are present and verified?",
          cite: "OP-011",
          options: [
            "Officially valid document for identity, verified against the original",
            "Address proof in the applicant's own name",
            "Recent photograph",
            "Permanent account number, consistent with the identity document",
            "Beneficial ownership established for every holder above the threshold",
            "Authorised signatory evidence",
            "Risk categorisation recorded",
          ] },
        { id: "addressMismatch", type: "confirm", q: "Does the address on the identity document differ from the one declared?",
          cite: "OP-011", yes: "Yes, they differ", no: "No, they agree" },
        { id: "registrySearched", type: "confirm", q: "Has the central registry been searched for an existing identifier?",
          cite: "OP-011",
          yes: "Yes, searched", no: "Not yet",
          help: "Creating a duplicate registry record for a customer who already has one follows them for years." },
        { id: "acceptability", type: "check", q: "Whether the pack is acceptable",
          rules: [
            { label: "Officially valid document verified against the original", of: "documents",
              test: "includes", value: "Officially valid document for identity, verified against the original",
              cite: "OP-011",
              fail: "A relationship is not commenced on the basis that identification will follow" },
            { label: "Address proof in the applicant's own name", of: "documents",
              test: "includes", value: "Address proof in the applicant's own name", cite: "OP-011",
              fail: "A document in a relative's name is not address proof for this applicant" },
            { label: "Beneficial ownership established", of: "documents",
              test: "includes", value: "Beneficial ownership established for every holder above the threshold",
              cite: "CM-001", when: { custType: ["Partnership", "Company", "Trust or society"] },
              na: "Individual or proprietorship: no beneficial ownership requirement",
              fail: "Required for every non-individual customer before the relationship commences" },
            { label: "Risk categorisation recorded", of: "documents",
              test: "includes", value: "Risk categorisation recorded", cite: "CM-001",
              fail: "The categorisation drives the depth of due diligence and the update cycle" },
            { label: "Registry searched before a new record is created", of: "registrySearched",
              test: "truthy", cite: "OP-011", blocking: false,
              fail: "Search first, and download an existing identifier rather than creating a duplicate" },
          ] },
        { id: "upload", type: "clock", q: "The registry upload window",
          clocks: [
            { label: "Upload to the central registry", from: "relationshipStart", every: 7, unit: "days",
              owner: "Central Operations",
              consequence: "Identification deficiencies are the most common cause of monetary penalties against lenders",
              cite: "OP-011" },
          ] },
      ],
      produce: {
        kind: "Identification assessment",
        title: "Identification pack for {customer}",
        meta: [
          { k: "Customer", from: "customer" }, { k: "Type", from: "custType" },
          { k: "Relationship commenced", from: "relationshipStart" },
        ],
        sections: [
          { h: "Whether the pack is acceptable", fromStep: "acceptability" },
          { h: "Registry upload window", fromStep: "upload" },
          { h: "Search the registry first", fromDoc: "OP-011", para: 2 },
          { h: "The exception queue", fromDoc: "OP-011", para: 4 },
        ],
        halt: {
          kind: "Pack not acceptable",
          title: "Identification pack incomplete for {customer}",
          intro: "This pack does not meet the standard and the relationship may not proceed on it.",
          route: "Obtain the outstanding items and run this again. Where the applicant cannot produce an acceptable document, refer to the branch manager rather than proceeding on a substitute.",
        },
        footer: "The officer who verified each document is recorded by name. Records are retained for the period required by the framework, measured from the end of the relationship.",
      },
    },

    {
      id: "gold_auction",
      title: "Gold loan cover, notice and auction settlement",
      tagline: "Loan to value against the reference rate, and the clocks that run after a sale",
      icon: "lock",
      for: ["gold_appraiser", "branch_manager", "central_ops", "head_collections"],
      triggers: ["gold loan ltv", "gold auction", "release the ornaments", "surplus after auction",
                 "gold cover breach", "pledged ornaments"],
      doneTitle: "Position worked out",
      doneNote: "The cover position, the notice and the settlement clocks are in the workspace.",
      steps: [
        { id: "account", type: "text", q: "Which gold loan account?" },
        { id: "netWeight", type: "number", q: "Net weight of gold content, in grams?",
          cite: "CR-009", help: "Stones, enamel and any non-gold component are excluded entirely." },
        { id: "refRate", type: "number", q: "Reference rate per gram published by Treasury?",
          cite: "CR-009", help: "The average closing price of the preceding thirty days for the relevant purity." },
        { id: "outstanding", type: "number", q: "Outstanding including accrued interest?" },
        { id: "stage", type: "choice", q: "What stage is this account at?",
          options: [
            { v: "Live", t: "Live, checking cover" },
            { v: "Breach", t: "Cover breached, notice due" },
            { v: "Sold", t: "Auctioned, settling the account" },
          ], cite: "CR-009" },
        { id: "saleDate", type: "date", q: "Date of the auction?", optional: true,
          when: { stage: "Sold" }, cite: "CR-009" },
        { id: "proceeds", type: "number", q: "Sale proceeds?", optional: true,
          when: { stage: "Sold" } },
        { id: "costs", type: "number", q: "Reasonable and evidenced costs of the auction?",
          optional: true, when: { stage: "Sold" }, cite: "CR-009" },
        { id: "cover", type: "calc", q: "Cover position",
          compute: {
            lines: [
              { label: "Value of pledged ornaments", op: "multiply", of: ["netWeight", "refRate"],
                as: "V", cite: "CR-009",
                note: "Net gold content at the published reference rate; making charges and stones excluded" },
              { label: "Outstanding including accrued interest", op: "value", from: "outstanding",
                as: "O", cite: "CR-009" },
              { label: "Loan to value", op: "ratio", part: "outstanding", whole: "V",
                as: "LTV", unit: "percent", cite: "CR-009",
                note: "Funding does not exceed 75 per cent at any time during the tenor" },
              { label: "Surplus returnable to the customer", op: "subtract",
                of: ["proceeds", "outstanding", "costs"], as: "SUR", cite: "CR-009",
                when: { stage: "Sold" },
                because: "Not applicable: the ornaments have not been sold",
                note: "Returned within seven working days of the sale, with the computation given to the customer" },
            ],
            total: { label: "Loan to value", of: ["LTV"], unit: "percent" },
          } },
        { id: "clocks", type: "clock", q: "The clocks that run",
          clocks: [
            { label: "Surplus returned to the customer", from: "saleDate", every: 7, unit: "days",
              owner: "Branch", consequence: "With the computation of dues and costs, given rather than provided on request",
              cite: "CR-009" },
          ] },
        { id: "noticeGiven", type: "confirm", q: "Was prior notice of the auction given, stating date and place?",
          optional: true, when: { stage: "Sold" }, cite: "CR-009" },
        { id: "didNotBid", type: "confirm", q: "Confirm Kritanya did not participate in the auction",
          optional: true, when: { stage: "Sold" }, cite: "CR-009" },
        { id: "conduct", type: "check", q: "What the procedure requires",
          rules: [
            { label: "Loan to value within the ceiling", of: "cover", test: "lte", value: 75,
              cite: "CR-009",
              fail: "Give notice to pay the shortfall or pledge additional ornaments. A facility in breach is not renewed and is not topped up" },
            { label: "Prior notice of the auction given to the customer, stating date and place",
              of: "noticeGiven", test: "truthy", cite: "CR-009",
              when: { stage: "Sold" }, na: "Not at auction stage" },
            { label: "Kritanya did not participate in the auction", of: "didNotBid",
              test: "truthy", cite: "CR-009", when: { stage: "Sold" }, na: "Not at auction stage",
              fail: "Kritanya does not bid on the auction of its own pledged ornaments" },
          ] },
      ],
      produce: {
        kind: "Gold loan position",
        title: "Gold loan position on {account}",
        meta: [
          { k: "Account", from: "account" }, { k: "Net weight (g)", from: "netWeight" },
          { k: "Reference rate", from: "refRate" }, { k: "Stage", from: "stage" },
        ],
        sections: [
          { h: "Cover position", fromStep: "cover" },
          { h: "What the procedure requires", fromStep: "conduct" },
          { h: "Clocks", fromStep: "clocks" },
          { h: "Release on closure", fromDoc: "OP-008", para: 6 },
        ],
        footer: "Where release is delayed beyond seven working days for a reason attributable to Kritanya, compensation is payable at the rate in the pricing circular for each day of delay, and the delay is reported as an incident.",
      },
    },
    ...
    {
      id: "complaint_triage",
      title: "Complaint triage and escalation readiness",
      ...
      steps: [
        { id: "reference", type: "text", q: "Complaint reference?" },
        { id: "received", type: "date", q: "Date first received anywhere in Kritanya?",
          cite: "GP-005",
          help: "The clock runs from first receipt, not from the date it reached the officer answering it." },
        { id: "channel", type: "choice", q: "How did it arrive?",
          options: ["Branch", "Contact centre", "Email", "Post", "Digital application",
                    "Through a service provider", "Forwarded by an external forum"], cite: "SV-004" },
        { id: "rootCause", type: "choice", q: "What is the root cause, on investigation?",
          cite: "GP-005",
          options: [
            "Recovery conduct", "Charge disputed", "Turnaround and delay",
            "Document return or no-objection certificate", "Statement or account information",
            "Mis-selling of an optional product", "Credit information reporting", "Other",
          ] },
        { id: "commsChecked", type: "confirm", q: "Has the actual communication the customer received been retrieved and compared against the policy in force on the date it was sent?",
          cite: "SV-004",
          yes: "Yes, retrieved and compared", no: "Not yet",
          help: "Where a customer says an amount does not match what they were told, this is the step that establishes which of the two was wrong." },
        { id: "similarCount", type: "number", q: "How many complaints with this root cause in the rolling quarter?",
          cite: "GP-005" },
        { id: "customerRight", type: "confirm", q: "On the evidence, is the customer right?",
          cite: "SV-004", yes: "Yes, wholly or in part", no: "No" },
        { id: "clock", type: "clock", q: "The response clock",
          clocks: [
            { label: "Final response due", from: "received", every: 30, unit: "days",
              owner: "Grievance Redressal Officer",
              consequence: "Where it cannot be resolved in time the customer must be told in writing before the thirtieth day, with a reason and a revised date",
              cite: "GP-005" },
            { label: "First level resolution target", from: "received", every: 7, unit: "days",
              owner: "Branch or contact centre", consequence: "After this it escalates to the Grievance Redressal Officer",
              cite: "GP-005" },
          ] },
        { id: "readiness", type: "check", q: "Before this is closed",
          rules: [
            { label: "The communication the customer received has been checked",
              of: "commsChecked", test: "truthy", cite: "SV-004",
              fail: "Closing on the customer's description without checking what was actually sent records a comprehension problem where there may be a communication error" },
            { label: "Not a systemic pattern", of: "similarCount", test: "lte", value: 5,
              cite: "GP-005",
              fail: "More than five complaints with this root cause in a rolling quarter. This escalates to the Chief Compliance Officer as a potential systemic issue regardless of how easily the individual cases were settled" },
            { label: "Where the customer is right, the affected population has been considered",
              of: "customerRight", test: "falsy", cite: "SV-004", blocking: false,
              fail: "An exception arising from a template, a parameter or a policy interpretation is remediated for the whole affected population without waiting for those customers to complain" },
          ] },
      ],
      produce: {
        kind: "Complaint triage note",
        title: "Triage of complaint {reference}",
        meta: [
          { k: "Reference", from: "reference" }, { k: "Received", from: "received" },
          { k: "Channel", from: "channel" }, { k: "Root cause", from: "rootCause" },
        ],
        sections: [
          { h: "The response clock", fromStep: "clock" },
          { h: "Before this is closed", fromStep: "readiness" },
          { h: "Root cause classification", fromDoc: "GP-005", para: 4 },
          { h: "The external route", fromDoc: "GP-005", para: 3 },
        ],
        halt: {
          kind: "Escalation required",
          title: "Complaint {reference} requires escalation",
          intro: "This complaint cannot be closed at this level. The position below is referred rather than resolved here.",
          route: "Refer to the Chief Compliance Officer where a systemic pattern is indicated, and retrieve the actual customer communication before any closure classification is recorded.",
        },
        footer: "A complaint closed in the system without a response having gone out is reopened on discovery and reported as a process failure.",
      },
    },

    {
      id: "circular_impact",
      title: "Regulatory circular impact assessment",
      tagline: "Everything a change touches, with an owner and a date against each",
      icon: "route",
      for: ["chief_compliance", "reporting_analyst", "internal_auditor", "cro", "digital_pm"],
      triggers: ["circular impact", "what does this circular change", "regulatory change assessment",
                 "implementation plan", "what has to change", "impact assessment"],
      doneTitle: "Impact mapped",
      doneNote: "The chain from the requirement through to the evidence is in the workspace, with an owner against each link.",
      steps: [
        { id: "instrument", type: "text", q: "Which instrument?", placeholder: "Circular reference and date" },
        { id: "published", type: "date", q: "Date published?", cite: "CM-004" },
        { id: "effective", type: "date", q: "Effective date?", cite: "CM-004" },
        { id: "entities", type: "multi", q: "Which entities does it bind?",
          cite: "CM-004",
          options: ["Kritanya Finserv Limited", "Kritanya Housing Finance Limited", "Kritanya Microfinance Limited"] },
        { id: "links", type: "table", q: "The chain, with an owner and a date against each link",
          cite: "CM-004",
          columns: [
            { key: "link", label: "What must change" },
            { key: "detail", label: "Which one" },
            { key: "owner", label: "Owner" },
            { key: "due", label: "Due", kind: "date" },
          ] },
        { id: "systems", type: "number", q: "In how many systems is the affected template configured?",
          cite: "PR-008",
          help: "Loan management, the communication platform and the collections system each hold their own copy. Changing one does not change the others." },
        { id: "evidenced", type: "confirm", q: "Is completion evidenced by the configuration record from every system?",
          cite: "CM-004",
          yes: "Yes, from each system", no: "No, or by email confirmation only" },
        { id: "assessment", type: "clock", q: "The assessment deadline",
          clocks: [
            { label: "Impact assessment complete", from: "published", every: 10, unit: "days",
              owner: "Chief Compliance Officer",
              consequence: "The failure mode is not missing a circular; it is reading one, changing the policy, and never changing the six other things the policy touched",
              cite: "CM-004" },
            { label: "Compliance testing on live cases", from: "effective", every: 3, unit: "months",
              owner: "Compliance testing",
              consequence: "Testing looks at what a customer actually received, not at the documentation of the change",
              cite: "CM-006" },
          ] },
        { id: "completeness", type: "check", q: "Whether the chain is complete",
          rules: [
            { label: "Every entity assessed separately", of: "entities", test: "present",
              cite: "CM-004",
              fail: "The same instrument may bind one entity and not another" },
            { label: "Every link has an owner and a date", of: "links", test: "present",
              cite: "CM-004", fail: "A link without an owner is a link nobody closes" },
            { label: "Template link covers every system it is configured in",
              of: "systems", test: "gte", value: 2, cite: "PR-008", blocking: false,
              fail: "A change recorded as complete because the primary system was updated leaves templates in the secondary systems untouched" },
            { label: "Completion evidenced by configuration records", of: "evidenced",
              test: "truthy", cite: "CM-004",
              fail: "An email confirming that a change was requested is not evidence of implementation" },
          ] },
      ],
      produce: {
        kind: "Impact assessment",
        title: "Impact assessment: {instrument}",
        meta: [
          { k: "Instrument", from: "instrument" }, { k: "Published", from: "published" },
          { k: "Effective", from: "effective" },
        ],
        sections: [
          { h: "The chain", fromTable: "links" },
          { h: "Whether the chain is complete", fromStep: "completeness" },
          { h: "Deadlines", fromStep: "assessment" },
          { h: "The link most often missed", fromDoc: "CM-004", para: 3 },
        ],
        halt: {
          kind: "Assessment incomplete",
          title: "Impact assessment incomplete: {instrument}",
          intro: "This assessment cannot be signed off in its current state.",
          route: "Complete the outstanding links and obtain the configuration record from every system in which the affected template exists.",
        },
        footer: "An item recorded as closed that testing later finds open is reported as a failed closure and not silently reopened.",
      },
    },

    {
      id: "covenant_monitoring",
      title: "Covenant testing and breach handling",
      tagline: "What was due, what arrived, and what a missed test actually means",
      icon: "building",
      for: ["wholesale_rm", "cro", "cco", "portfolio_risk", "legal_recovery"],
      triggers: ["covenant test", "covenant breach", "security cover covenant",
                 "covenant waiver", "monitoring calendar", "information covenant"],
      doneTitle: "Position established",
      doneNote: "The tests, the breaches and the waiver position are in the workspace. Only the Credit Committee may waive a covenant.",
      steps: [
        { id: "borrower", type: "text", q: "Which borrower?" },
        { id: "facility", type: "choice", q: "What kind of facility?",
          options: ["Structured finance", "Promoter funding", "Real estate project finance",
                    "Special situations", "Mezzanine"], cite: "WH-001" },
        { id: "testDate", type: "date", q: "Test date under the agreement?", cite: "WH-001" },
        { id: "covenants", type: "table", q: "Covenants tested this period",
          cite: "WH-001",
          columns: [
            { key: "covenant", label: "Covenant" },
            { key: "required", label: "Required" },
            { key: "actual", label: "Actual" },
            { key: "status", label: "Met or breached" },
          ] },
        { id: "evidenceReceived", type: "confirm", q: "Was the evidence received in the form the agreement requires, by the test date?",
          cite: "WH-001",
          yes: "Yes, in the required form", no: "No, late or in a different form",
          help: "A certificate in a form other than the one prescribed is not evidence of compliance." },
        { id: "coverPct", type: "number", q: "Security cover achieved, per cent?",
          optional: true, cite: "WH-001" },
        { id: "requiredCover", type: "number", q: "Covenanted cover, per cent?",
          optional: true, cite: "WH-001" },
        { id: "waiverSought", type: "confirm", q: "Is a waiver being sought?", cite: "WH-001" },
        { id: "testing", type: "check", q: "The position on these tests",
          rules: [
            { label: "Evidence received by the test date in the required form",
              of: "evidenceReceived", test: "truthy", cite: "WH-001",
              fail: "Where the evidence has not been received by the test date, the covenant is treated as breached unless the agreement expressly provides otherwise. Silence is not a cure" },
            { label: "Security cover at or above the covenanted level",
              of: "coverPct", test: "gte", value: 200, cite: "WH-001", blocking: false,
              fail: "Cover below the covenanted level triggers the top-up mechanism, and the cure period runs from the date of the test rather than from when it was raised" },
            { label: "Any waiver goes to the Credit Committee with an expiry date",
              of: "waiverSought", test: "falsy", cite: "WH-001", blocking: false,
              fail: "A relationship manager, a business head and the Chief Credit Officer individually may not waive a covenant. A waiver without an expiry date has not been granted" },
          ] },
        { id: "reporting", type: "clock", q: "Reporting deadlines",
          clocks: [
            { label: "Missed test reported as an exception", from: "testDate", every: 15, unit: "days",
              owner: "Chief Risk Officer",
              consequence: "Reported whether or not the underlying position is believed to be sound",
              cite: "WH-001" },
          ] },
      ],
      produce: {
        kind: "Covenant testing note",
        title: "Covenant position for {borrower}",
        meta: [
          { k: "Borrower", from: "borrower" }, { k: "Facility", from: "facility" },
          { k: "Test date", from: "testDate" },
        ],
        sections: [
          { h: "Covenants tested", fromTable: "covenants" },
          { h: "The position on these tests", fromStep: "testing" },
          { h: "Reporting", fromStep: "reporting" },
          { h: "A missed test", fromDoc: "WH-001", para: 5 },
          { h: "Waivers", fromDoc: "WH-001", para: 7 },
        ],
        halt: {
          kind: "Covenant breach",
          title: "Covenant breach for {borrower}",
          intro: "This facility is in breach. The rights available under the agreement are identified before any conversation with the borrower, because rights not reserved in that conversation may be lost.",
          route: "Notify the Chief Risk Officer today and report to the Credit Committee at its next meeting, with the cause, the exposure, the remediation and the date by which the position returns inside the covenant.",
        },
        footer: "A facility carrying a rolling series of waivers is a facility whose covenant package no longer describes the risk, and is re-documented rather than waived again.",
      },
    },
  ],
  ...
  kb: [
    ...
    },
    {
      ...
      body:
        "This code governs Kritanya Finserv Limited and both subsidiaries and applies to every employee, direct sourcing agent, business correspondent, lending service provider and recovery agency acting on their behalf. Engaging an agent does not transfer the obligation; what the agent does, Kritanya has done.\n\n" +
        ...
        "Recovery conduct. Kritanya does not resort to harassment. Recovery does not involve persistently bothering the borrower at odd hours, contact outside the hours permitted by the collections policy, the use of muscle power, contact with persons who are not the borrower or the guarantor, disclosure of the debt to any third party, or any conduct that humiliates the borrower or their family. Every person recovering on Kritanya's behalf is trained on this paragraph and their authorisation names it.\n\n" +
        ...
        "Release of securities. On repayment of all dues, all securities are released within the period stated in the product note, and the release is not made conditional on the settlement of any other claim Kritanya may have against the borrower unless that right is expressly reserved in the agreement and notice of it has been given.",
    },
    {
      ...
      body:
        "Every customer of Kritanya Finserv Limited and its subsidiaries has a right to be heard and to be told what was decided and why. This policy applies to complaints received at a branch, through the contact centre, by email, by post, through a digital application, through a lending service provider, or forwarded by any external forum.\n\n" +
    ...
    },
    {
      ...
      body:
        "Kritanya outsources a number of activities: sourcing, field verification, tele-calling, field collections, valuation, document storage, technology hosting and parts of the digital lending journey. Outsourcing an activity never outsources the responsibility for it. Kritanya remains answerable to its customers and to the regulator for anything done on its behalf.\n\n" +
        ...
        "Materiality. Each arrangement is assessed as material or non-material against the disruption it would cause on failure, the customer data it touches and the concentration it creates. Material arrangements require board committee approval, a documented due diligence file, a written agreement with defined service levels, audit and inspection rights covering the regulator as well as Kritanya, business continuity provisions, and a tested exit plan. A material arrangement without an exit plan is a finding.\n\n" +
        ...
        "Conduct and training. Every person employed by a service provider who deals with an Kritanya customer is trained on the fair practices code and the collections conduct rules, carries an identity card and a written authorisation naming Kritanya, and is registered against the arrangement. Kritanya may require the removal of any such person from Kritanya work without stating a reason.\n\n" +
    ...
    },
    {
      ...
      body:
        ...
        "Protection. Retaliation against a person who raises a concern in good faith is a dismissible matter. Retaliation includes dismissal, demotion, transfer, withholding of increment or incentive, exclusion from work, and informal pressure. This protection extends to service provider personnel working on Kritanya business. A concern that turns out to be mistaken is protected; a concern raised in bad faith to cause harm is not.\n\n" +
    ...
    },
    {
      ...
      body:
        "A conflict of interest exists wherever a person's private interest could influence, or could reasonably appear to influence, a decision they take on Kritanya's behalf. The test is appearance as well as fact, because a decision that has to be explained afterwards is already expensive.\n\n" +
    ...
    /* ================= CREDIT POLICY ================= */
    {
      ...
      body:
        "This policy governs credit decisions in Kritanya Finserv Limited. Kritanya Housing Finance and Kritanya Microfinance maintain their own credit policies which are aligned to this one but are not replaced by it. Where a product note and this policy differ, this policy governs and the product note is corrected.\n\n" +
        ...
        "Ability to verify. Kritanya does not lend where it cannot verify. Where income cannot be documented in any of the ways the product note permits, the file is declined rather than approved against a higher rate or a lower loan to value. Pricing does not cure an unverifiable file.\n\n" +
    ...
    },
    {
      ...
      body:
        "Loan against property is a secured facility to individuals and non-individual entities against residential or commercial property owned by the borrower or a co-applicant. Written by Kritanya Finserv Limited. Loans for the purchase or construction of a residence are written by Kritanya Housing Finance under its own product note and are not covered here.\n\n" +
        ...
        "Documentation. Identification and address for every applicant, income as per the income assessment standards, property title chain, valuation, insurance of the property assigned to Kritanya, and the security documents appropriate to the state. Insurance covering the property for not less than the outstanding is a continuing obligation, not a one-time document.",
    },
    {
      ...
      body:
        "An unsecured term facility to proprietorships, partnerships, limited liability partnerships and private limited companies for working capital and business expansion. Written by Kritanya Finserv Limited.\n\n" +
        "Eligibility. Business vintage of three completed years evidenced by registration and by banking. Minimum annual turnover 40 lakh where assessed on financial statements, 60 lakh where assessed on a banking surrogate. Applicant aged 25 to 60 at maturity. The business and the applicant must both be resident in a location Kritanya serves, and the business premises must be verifiable.\n\n" +
    ...
    },
    {
      ...
      body:
        "An unsecured term facility to salaried individuals for personal purposes. Written by Kritanya Finserv Limited and offered through branches, direct sourcing agents and the digital channel.\n\n" +
    ...
    },
    {
      ...
      body:
        "Finance for new and used commercial vehicles: goods carriers, passenger carriers, tippers and construction equipment. Written by Kritanya Finserv Limited and sourced principally through dealer counters and direct sourcing agents.\n\n" +
        ...
        "Security. Hypothecation of the vehicle endorsed on the registration certificate, comprehensive insurance with Kritanya as loss payee, and a personal guarantee for non-individual borrowers. The endorsement of hypothecation on the registration certificate is a post-disbursement obligation with a hard timeline and is the single largest open item in the secured book.\n\n" +
    ...
    },
    {
      ...
      body:
        "A facility against the pledge of gold ornaments, written by Kritanya Finserv Limited at designated branches only. Ornaments only: bullion, coins other than those permitted, and primary gold are not accepted.\n\n" +
    ...
    },
    {
      ...
      body:
        "Facilities against listed securities and mutual fund units, including margin trade funding, employee stock option financing and public issue financing. Written by Kritanya Finserv Limited from the Mumbai desk only. This is the one product where the security's value changes every trading day, and every rule below follows from that.\n\n" +
    ...
    },
    {
      ...
      owner: "Kritanya Microfinance, Head of Credit", updated: "2026-03-11", rev: "5.3", system: "Policy Repository",
      tags: ["microfinance", "JLG", "joint liability", "household income", "indebtedness", "centre meeting", "collateral free", "MFI"],
      body:
        "Collateral-free loans to women organised in joint liability groups, written by Kritanya Microfinance Limited, an NBFC-MFI. This product is not written by Kritanya Finserv Limited and the parent's credit policy does not govern it; this note and the microfinance credit policy do.\n\n" +
    ...
    },
    {
      ...
      body:
        "This schedule lists every charge Kritanya Finserv Limited may recover from a borrower. A charge that is not in this schedule may not be recovered, whatever a system parameter, a letter or a local practice says. Every charge is disclosed in the key facts statement before the contract is executed and is displayed on the website.\n\n" +
    ...
    },
    {
      ...
      body:
        "This policy replaced the previous penal interest regime across Kritanya Finserv Limited and both subsidiaries with effect from 1 April 2024. It governs every charge levied on a borrower for a delay in payment or for non-compliance with a term of the facility.\n\n" +
    ...
    },
    {
      ...
      body:
        "This policy governs what may be recovered when a borrower repays a facility of Kritanya Finserv Limited ahead of schedule, in whole or in part. It applies to facilities sanctioned or renewed on or after 1 January 2026. Facilities sanctioned before that date are governed by the terms of their own agreements, and the applicable regime is determined by the sanction date recorded on the file rather than by the date of the request.\n\n" +
    ...
    },
    {
      ...
      body:
        "This circular sets out the terms of the dealer subvention scheme on used commercial vehicles, under which a participating dealer bears part of the interest cost for an initial period in return for an agreed volume commitment. It applies to Kritanya Finserv Limited and supersedes revision 5.2 with effect from 1 March 2026. The scheme is co-terminus with the dealer agreements and comes up for renewal on 31 October 2026, and the participating dealer agreements auto-renew on that date unless notice is given 30 days beforehand.\n\n" +
    ...
    },
    {
      ...
      body:
        "This register lists the customer-facing templates in use across Kritanya Finserv Limited: letters, notices, reminders, statement narrations, sanction and key facts formats, and the message templates used in the digital and messaging channels. For each template it records the owner, the current version, the date it was last reissued, and the systems in which it is configured.\n\n" +
    ...
    },
    {
      ...
      body:
        "Kritanya distributes insurance as a corporate agent and requires insurance as security on certain facilities. The two are different things and are never presented to a customer as the same thing.\n\n" +
        "Insurance required as security. Where the product note requires the financed asset or the mortgaged property to be insured, the requirement is a condition of the facility, the sum insured is not less than the outstanding, and Kritanya is recorded as loss payee. The borrower is free to place that insurance with any insurer of their choice that meets the stated conditions. A borrower who chooses their own insurer is not charged differently and is not delayed.\n\n" +
        "Insurance sold as a product. Life, health and other cover distributed by Kritanya is optional in every case. Optional means the facility is sanctioned, priced and disbursed identically whether or not the customer takes it. A customer's decision not to take an optional product is recorded, and no file may be held, re-priced or re-appraised because of it.\n\n" +
    ...
    },
    {
      ...
      body:
        ...
        "Kritanya Finserv Limited. Loan against property; business loan unsecured; personal loan; consumer durable finance; commercial vehicle finance covering new, used and construction equipment; car finance covering new and used; two-wheeler finance; tractor finance; gold loan; loan against securities; margin trade funding; employee stock option financing; public issue financing; wholesale structured finance; promoter funding; real estate project finance.\n\n" +
        "Kritanya Housing Finance Limited. Home loan for purchase; home loan for construction; home improvement; balance transfer with top-up; affordable housing. Each carries its own product note under the housing finance company's own credit policy.\n\n" +
        "Kritanya Microfinance Limited. Joint liability group income generation loan; group emergency loan; individual graduation loan for members completing three cycles.\n\n" +
    ...
    },
    {
      ...
      body:
        ...
        "Execution. Every applicant, co-applicant and guarantor signs in person before an authorised Kritanya official or a person authorised in writing to witness. Signatures are matched against the identification record. A document signed outside the presence of a witnessing official is re-executed rather than accepted with a note.\n\n" +
    ...
    },
    {
      ...
      body:
        ...
        "Standard items and their clocks. Registration certificate bearing the endorsement of hypothecation: within 60 days of the vehicle being delivered, or 150 days from the date of first disbursal, whichever falls earlier. Registered mortgage where registration follows disbursal: within 30 days. Filing of the security interest with the registry: within 30 days of creation. Insurance policy copy with Kritanya as loss payee: within 30 days. End use evidence where the product note requires it: within 90 days. Occupancy or completion certificate on a construction facility: as set in the sanction.\n\n" +
    ...
    },
    {
      ...
      body:
        "Every rupee received is applied to an account on the day it is realised, or is held in an identified unapplied account and investigated. Money received and not applied is money the customer has paid and Kritanya has not recognised, and it produces a delinquency that is not real.\n\n" +
        ...
        "Field cash. Cash collected in the field is receipted to the customer at the point of collection from a pre-numbered receipt or the mobile application, and remitted the same day or by the start of the next working day where collection is after banking hours. An unremitted collection beyond that is escalated to the Area Collections Manager the same day and to the risk containment unit if unexplained after 24 hours. The receipt issued to the customer is the customer's proof of payment regardless of whether the money reached Kritanya.\n\n" +
    ...
    },
    {
      ...
      body:
        "Security interests created in favour of Kritanya are registered with the central registry within the period prescribed, and satisfaction is filed when the facility closes. Registration establishes priority against other creditors and puts the world on notice; an unregistered charge is a charge Kritanya may be unable to rely on when it matters.\n\n" +
    ...
    },
    {
      ...
      body:
        "Kritanya's interest in a financed vehicle is recorded by an endorsement of hypothecation on the certificate of registration issued by the transport authority. Until that endorsement exists, the vehicle is registered in the borrower's name with no record of Kritanya's interest, and the exposure is unsecured in substance whatever the loan documents say.\n\n" +
        "Obtaining the endorsement. The dealer or the borrower files the registration application together with the hypothecation form signed by Kritanya. Central Operations issues the signed form on disbursal and records the case as a post disbursement item due within 60 days of delivery or 150 days from first disbursal, whichever is earlier.\n\n" +
        "Verification on receipt. The certificate is verified against the loan record for the registration number, engine number, chassis number, the borrower's name, and the presence and correctness of the hypothecation endorsement in Kritanya's name. A certificate received with the endorsement missing, in the wrong name, or with a mismatched chassis number is not closure and is returned for correction.\n\n" +
        "Insurance linkage. Comprehensive insurance with Kritanya as loss payee is verified against the registration number at the same time, and renewal is tracked annually for the life of the facility. A financed vehicle running without insurance is an uncovered exposure, and the renewal check is not optional because the endorsement is in place.\n\n" +
        "Termination on closure. On closure, Kritanya issues the no-objection certificate and the termination of hypothecation form to the borrower within seven working days, and the borrower files for removal of the endorsement. Where the borrower does not file, Kritanya's obligation is discharged by issuing the documents, but the closure record notes it.\n\n" +
        "Repossessed and sold vehicles. Where a vehicle is sold following repossession, the transfer and the removal of the endorsement are completed as part of the sale, and the file is not closed until both are evidenced. An endorsement left in place on a vehicle Kritanya has sold produces a claim from the buyer later.\n\n" +
    ...
    },
    {
      ...
      body:
        "These are the commitments Kritanya makes on how long things take. Each is measured from the point the customer's request is complete, and the measurement is published internally by product and branch each month.\n\n" +
        ...
        "Grievances. Acknowledgement immediately with a reference. Resolution within seven working days at the first level, and a final response within 30 days of first receipt anywhere in Kritanya.\n\n" +
        ...
        "Failure to meet a standard. Where a standard is missed, the customer is informed with a reason and a revised date before the standard expires, not afterwards. Where a delay in returning documents or filing satisfaction is attributable to Kritanya, compensation is payable as set out in the relevant product note, and the payment does not require the customer to ask for it.",
    },
    ...
    /* ================= COLLECTIONS AND RECOVERY ================= */
    {
      ...
      body:
        "This policy governs recovery across Kritanya Finserv Limited and both subsidiaries, whether the recovery is by an employee, an empanelled agency, a business correspondent or a legal representative. Recovery is a commercial activity conducted within a conduct boundary, and where the two conflict the conduct boundary governs.\n\n" +
        ...
        "What is never permitted. Contact outside the permitted hours. Contact with any person who is not the borrower or a guarantor about the debt. Disclosure of the debt to an employer, a neighbour, a relative or a colleague. Any threat, of legal action that is not available, of criminal consequence, or of anything else. Any use or suggestion of force. Publication of a borrower's name or photograph. Retaining a borrower's documents, identity papers or property as leverage. Persistent calling designed to harass rather than to reach the borrower. These apply to every person recovering on Kritanya's behalf, and to conduct on any channel including messaging.\n\n" +
        ...
        "Recovery is not the only answer. Where an account is delinquent for a reason within Kritanya's control, such as a mandate that was never registered, a receipt that was not applied, or a charge that should not have been levied, it is corrected rather than collected. Collecting on a delinquency Kritanya created is the most expensive mistake available in this function.",
    },
    {
    ...
    },
    {
      ...
      body:
        "This code binds every person who contacts an Kritanya borrower about an overdue amount: employees, empanelled agency staff, business correspondents and legal representatives. It is issued with the authorisation letter and acknowledged in writing before any allocation is made.\n\n" +
        "Identification. Every agent carries a photo identity card issued by their employer and a written authorisation from Kritanya naming the agent, the agency, the period of validity and this code. Both are shown to the borrower unprompted at the start of any visit. An agent who cannot produce both is not authorised to be there, and a borrower is entitled to refuse the contact.\n\n" +
        ...
        "Money. An agent may accept payment only where authorised for that account, and issues a pre-numbered receipt or a system receipt at the moment of collection. The receipt is the borrower's proof of payment and is valid against Kritanya whether or not the money is remitted. An agent who collects without receipting is dismissed and reported.\n\n" +
        "Consequences. A breach of this code is grounds for immediate withdrawal of authorisation. A serious breach ends the agency's empanelment and is reported to the Chief Compliance Officer. Kritanya does not accept an agency's explanation that a breach was the act of one person acting alone: the agency is responsible for the people it deploys, and Kritanya is responsible for the agency.",
    },
    {
      ...
      body:
        "Recovery agencies are empanelled against a documented process and reviewed continuously. Kritanya is answerable for what an agency does, so the empanelment file is a control document rather than a procurement record.\n\n" +
        ...
        "Deployment register. Every individual deployed on Kritanya accounts is registered by name, identity number, agency, territory and training completion date, before allocation. An account contacted by a person not on the register is an unauthorised contact and is reported as an incident whatever the outcome of the contact.\n\n" +
    ...
    },
    {
      ...
      body:
        ...
        "Opening. The agent identifies themselves by name, names Kritanya, states that the call concerns the borrower's loan account, and confirms they are speaking to the borrower before saying anything about the account. Where the person answering is not the borrower, the agent does not state the reason for the call and asks only for a convenient time to reach the borrower.\n\n" +
    ...
    },
    {
      ...
      body:
        "This standard governs visits to a borrower in arrears. A field visit is the most visible thing Kritanya does and it happens where the borrower's neighbours can see it, so the standard is written tightly.\n\n" +
        ...
        "Surrender of a financed asset. Where a borrower offers to surrender a financed vehicle, the officer does not take possession on the spot. Voluntary surrender follows the repossession procedure: the written surrender, the inventory, the valuation and the borrower's rights before sale all apply, and taking a vehicle on a doorstep conversation exposes Kritanya to a conversion claim however willing the borrower appeared.\n\n" +
    ...
    },
    {
      ...
      body:
        ...
        "Sale. By auction or through an approved channel, conducted transparently. Kritanya does not purchase the vehicle. No employee, agent, valuer, yard operator or their relatives may bid, directly or through another person, and a declaration to that effect is taken from the successful bidder.\n\n" +
        ...
        "Closing the file. The transfer of the vehicle and the removal of the endorsement of hypothecation are completed as part of the sale. The file is not closed until both are evidenced, because an endorsement left in place on a vehicle Kritanya has sold produces a claim from the buyer later.",
    },
    {
    ...
    },
    {
      ...
      body:
        "A write-off removes an exposure from the books. It does not extinguish the debt, does not release any security, and does not end Kritanya's right to recover. This document sets out when a write-off is recommended, who approves it, and what continues afterwards.\n\n" +
    ...
    },
    {
      ...
      owner: "Kritanya Microfinance, Head of Operations", updated: "2026-03-11", rev: "4.1", system: "Collections & Recovery",
      tags: ["microfinance", "centre meeting", "JLG", "group", "cash collection", "conduct", "no coercion", "residence", "MFI", "restructure"],
      body:
        "This standard governs collection by Kritanya Microfinance Limited. The joint liability model creates a specific risk: pressure applied to a group rather than to a borrower, which is both prohibited and, when it happens, invisible in the collection numbers because the money arrives.\n\n" +
        ...
        "Joint liability, honestly stated. The joint liability in this product is a mutual undertaking within the group and is not enforced by Kritanya as a legal guarantee against other members. Nothing is said to a group that implies otherwise, and no officer suggests that other members will be pursued for a member's dues.\n\n" +
    ...
    /* ================= RISK, CLASSIFICATION AND FRAUD ================= */
    {
      ...
      body:
        "This policy governs how an exposure is classified and provided for. It applies to Kritanya Finserv Limited; each subsidiary applies its own policy aligned to the framework applicable to it. Classification is a mechanical consequence of the day-end position, not a judgement, and it is never adjusted to produce a reported number.\n\n" +
        "Overdue. An amount is overdue if it has not been paid on the due date fixed by Kritanya. There is no grace period. An instalment due on the 5th and unpaid at the end of the 5th is overdue on the 5th, and the day count begins from that date.\n\n" +
    ...
    },
    {
      ...
      body:
        "The board sets the risk Kritanya is willing to accept in pursuit of its plan. This statement expresses that as limits, and a limit is a boundary rather than a target. Operating at a limit is not compliance, it is the absence of headroom.\n\n" +
    ...
    /* ================= COMPLIANCE, FINANCIAL CRIME AND AUDIT ================= */
    {
      ...
      body:
        "This policy governs customer identification, ongoing due diligence, transaction monitoring and reporting across Kritanya Finserv Limited and both subsidiaries. It is open to every employee, because everybody who onboards or services a customer operates under it. The case material generated under it is not open, and that distinction runs through this document.\n\n" +
    ...
    },
    {
      ...
      body:
        ...
        "Why this matters. Some holds sit behind obligations where any disclosure, including to the customer and including within Kritanya, is itself an offence. An employee who follows this document has met their obligation in full. An employee who tries to be helpful by finding out and explaining may create a personal liability for themselves as well as for Kritanya.",
    },
    {
      ...
      body:
        "This calendar lists every return Kritanya and its subsidiaries file, the entity that files it, the frequency, the due date, the data owner and the preparer. A return not on this calendar is not being tracked, and the completeness of the calendar is reviewed against the applicable frameworks each quarter.\n\n" +
    ...
    },
    {
      ...
      body:
        "Compliance testing checks that what Kritanya does matches what its policies say, on live cases rather than on documentation. It is second line assurance, distinct from internal audit, and it tests outcomes for customers rather than the existence of controls.\n\n" +
    ...
    },
    {
      ...
      body:
        "This procedure governs how Kritanya prepares for, conducts itself during, and responds to a supervisory inspection.\n\n" +
        ...
        "Responding to observations. Each observation gets a factual response, an agreed action, an owner and a date. Kritanya does not contest an observation that is correct, and does not accept one that is not. A commitment made in a response is tracked on the regulatory change register and evidenced in the same way as any other obligation, because an uncompleted commitment is the observation that returns.",
    },
    ...
    },
    {
      ...
      body:
        "Access to this document is confined to designated persons under the insider trading framework. Kritanya's non-convertible debentures are listed, which brings the group inside that framework even though its equity is not listed.\n\n" +
        ...
        "Trading window. The window closes for designated persons from the end of each quarter until the second working day after the results are published, and at any other time the Company Secretary determines. No designated person deals in the securities of Kritanya, or of a listed borrower about which they hold unpublished information, while the window is closed or while in possession of such information.\n\n" +
        ...
        "Breach. A suspected breach is reported to the Company Secretary and the audit committee immediately. Trading in breach is a matter for the regulator as well as for Kritanya, and the group cooperates fully.",
    },
    {
      ...
      body:
        ...
        "Retaliation monitoring. Where a discloser is identifiable within Kritanya, their employment record is monitored for twelve months for transfer, appraisal, increment and exclusion, and any adverse movement is examined by the Chairman of the Audit Committee before it takes effect.",
    },
    {
       ...
       people route around it instead of respecting it. */
    {
      ...
      body:
        "Kritanya's non-convertible debentures are listed. That brings the whole group inside the insider trading framework even though the equity is not listed, and it means information you may come across in an ordinary day's work can be price sensitive. This document is for everybody and explains what you must do. The list of designated persons, the database of who holds what, and the details of any specific matter are restricted to the Company Secretary's office.\n\n" +
        "What counts. Financial results before they are published. A change in provisioning or asset quality before it is reported. A rating action being discussed. A material acquisition, disposal, portfolio sale or capital raise. A significant regulatory action. A change in key managerial personnel. Information about a listed borrower that you learned because Kritanya lends to them.\n\n" +
        "What you must do. Treat it as confidential. Do not pass it on inside Kritanya to anyone who does not need it to do their job, and do not pass it outside at all, including to family. Do not deal in Kritanya's securities, or in the securities of a listed borrower you have learned something about, while you hold the information. Do not discuss it in a lift, a cab, a group chat or a social setting.\n\n" +
    ...
    },
    {
      ...
      body:
        ...
        "If somebody outside Kritanya asks. A police officer, a government office, a lawyer, a bank: route it to the Principal Officer and say that is what you are doing. Do not confirm or deny that somebody is a customer. Confirming it is itself a disclosure, and it is the one people give away without noticing.\n\n" +
...

    {
      ...
      body:
        ...
        "Tell the customer nothing about the merits. If the customer or their lawyer contacts you, take a note and pass it to Legal. Do not concede anything, do not deny anything, do not offer a settlement, and do not explain Kritanya's position.\n\n" +
    ...
    /* ================= CHANNELS, PRODUCTS AND SERVICE ================= */
    {
      ...
      body:
        "Small ticket finance for two-wheelers and consumer durables, written by Kritanya Finserv Limited and sourced principally at dealer counters. High volume, thin file, and the documentation checklist is therefore fixed rather than a matter of judgement at the counter.\n\n" +
        ...
        "Security. Hypothecation of the vehicle endorsed on the certificate of registration, and comprehensive insurance with Kritanya as loss payee. The endorsement is tracked as a post disbursement item under the standard timeline, and two-wheeler cases are the largest count in that population.",
    },
    {
      ...
      body:
        "Kritanya is a member of the credit information companies and both reports to them and draws from them. This policy covers both directions and the customer's rights in each.\n\n" +
        ...
        "Reporting. Kritanya reports the position of every borrower monthly within the cycle prescribed. Accounts are reported accurately: current as current, overdue with the correct days past due, settled as settled, and written off as written off. Reporting a settled account as closed, or delaying an adverse report, is a misreport and is corrected on discovery.\n\n" +
        "Corrections and disputes. A customer may dispute an entry with Kritanya or with the credit information company. Kritanya investigates from its own records, responds within the period prescribed, and where the entry is wrong, corrects it with the company and confirms the correction to the customer in writing. A correction is not conditional on the customer paying anything.\n\n" +
        "Telling the customer. Where an application is declined wholly or substantially because of the credit information report, the customer is told so and told how to obtain their own report. A customer is never told their score by an employee reading it off a screen, and never told that Kritanya can improve it.",
    },
    {
      ...
      body:
        "This handbook is for staff at dealer counters who originate Kritanya finance. It covers what to collect, what has to be complete before a vehicle leaves the floor, and who to contact when something is stuck.\n\n" +
        "Before delivery. A vehicle is not delivered against a sanction alone. Delivery may take place only when the sanction is in force, the loan agreement and security documents are executed by every applicant and guarantor, the margin has been received and evidenced, the repayment mandate is registered and confirmed active, insurance is in force with Kritanya as loss payee, and the disbursal has been released by Kritanya. A customer who wants to take delivery the same day can, provided all of these are complete the same day. Delivering against an expected disbursal is not permitted and the dealer carries the risk if it happens.\n\n" +
        ...
        "Registration and hypothecation. File the registration application with the hypothecation form signed by Kritanya, and send the certificate of registration bearing the endorsement to Kritanya as soon as it is issued. Holding certificates at the counter is the largest single cause of outstanding post disbursement documents, and payout is withheld on the specific case until it is received.\n\n" +
        "When a file is stuck. Contact the Kritanya dealer desk for the location with the application number. The desk responds within one working day with the specific item outstanding and who holds it. Escalation is to the Area Sales Manager for the territory, then to the regional vehicle finance head. Do not ask the customer to contact Kritanya directly and do not tell the customer that Kritanya has declined a file; declines are communicated by Kritanya in writing.",
    },
    {
      ...
      body:
        "This handbook is for direct sourcing agents and their staff. It sets out what a complete file is, how payout works, and the obligations that come with handling Kritanya customers and their documents.\n\n" +
        ...
        "One query, not several. Kritanya raises queries once, listing every gap. If a second query arrives on a point that was visible at the first, raise it with the desk, because that is a failure on Kritanya's side and it is measured.\n\n" +
        "What you may tell a customer. Product features, the documents required, the process and the indicative timeline. What you may not tell a customer: that a facility is approved, what rate they will get, what limit they will get, or when money will arrive. Those are Kritanya's to communicate and only after sanction. A commitment made at sourcing that Kritanya does not honour becomes a complaint against Kritanya and a conduct finding against the channel.\n\n" +
        ...
        "Customer data. Documents you collect belong to the customer and are held by you only to pass to Kritanya. Send them to Kritanya and do not retain copies beyond the period stated in the channel agreement. Do not store customer documents on personal devices or personal messaging accounts, do not share them with any other lender, and do not use a customer's details to source for anyone else. A customer's information obtained for an Kritanya application is used for that application and nothing else.\n\n" +
        "Conduct. Your staff act in Kritanya's name when they meet an Kritanya customer, and what they do, Kritanya has done. Every person you deploy is registered with Kritanya before they source, carries identification, and is trained on the fair practices code. Kritanya may require the removal of any person from Kritanya work without giving a reason.\n\n" +
        "What ends an empanelment. A non-genuine document in a file. A customer who says they never applied. Collecting money from a customer in Kritanya's name. Holding a customer's original documents. Sharing customer data. Misrepresenting a sanction. These end the relationship rather than attracting a warning.",
    },
    {
    ...
    /* ================= PARTNERSHIPS AND DIGITAL ================= */
    {
      ...
      body:
        "Kritanya participates in co-lending arrangements under which Kritanya and a partner bank each hold a share of the same loan to the same borrower on their own books. This policy governs those arrangements. It applies from 1 January 2026 to every arrangement entered into or renewed on or after that date.\n\n" +
        ...
        "Transfer timing. The partner's share of a loan originated by Kritanya is transferred within 15 calendar days of the loan being disbursed. A loan not transferred within that period is retained wholly by Kritanya and is not transferred later under the arrangement.\n\n" +
    ...
    },
    {
      ...
      body:
        ...
        "Partner A, secured retail. Kritanya 20 per cent, partner 80 per cent. Kritanya originates, appraises to the jointly agreed credit policy, and services. Part-prepayments are applied pro rata to both shares. Escrow settlement weekly. Reconciliation monthly, currently clean.\n\n" +
        "Partner B, business loans. Kritanya 20 per cent, partner 80 per cent. Kritanya originates and services. The operating agreement provides that part-prepayments are applied pro rata. The application rule as configured in Kritanya's loan management system applies a part-prepayment to Kritanya's share first and reduces the partner's share only when Kritanya's share is exhausted, which is not what the agreement provides. On accounts that have taken part-prepayments, Kritanya's retained share therefore falls faster than the partner's, and on a number of accounts it has fallen below the 10 per cent floor. The blended rate on those accounts no longer corresponds to the actual shares. This was identified at the May reconciliation, the population is being sized, and the configuration change is with technology.\n\n" +
        "Partner C, vehicle finance. Kritanya 25 per cent, partner 75 per cent. Partner originates, Kritanya services and collects. Escrow settlement fortnightly. Reconciliation monthly, two aged breaks relating to charges applied by Kritanya that the partner has not recognised.\n\n" +
    ...
    },
    {
      ...
      body:
        "This policy governs lending through digital channels and through lending service providers and digital lending applications acting for Kritanya. The obligations sit on Kritanya as the regulated entity; engaging a partner does not move them.\n\n" +
        "Register of applications. Every digital lending application through which Kritanya lends is recorded on the register, reported as required, and published on Kritanya's website. An application not on the published register is not authorised to source for Kritanya, and lending through one that is not on the register is a breach whatever the commercial arrangement says.\n\n" +
        ...
        "Data. Only data needed for the assessment is collected. Access to a borrower's contacts, media, call logs or location for any purpose other than a stated and consented one is prohibited. Customer data is stored on servers located in India. A partner may process data on Kritanya's behalf under the agreement; it does not hold it on its own account, may not use it for its own purposes or for any other lender, and returns or destroys it on termination with certification.\n\n" +
        "Flow of money. Disbursal is made directly from Kritanya to the borrower's own bank account, and repayments flow directly from the borrower to Kritanya. Neither passes through an account held by a partner or through any pool account. Any arrangement that routes borrower money through a partner is refused, whatever operational convenience is offered.\n\n" +
    ...
    /* ================= TREASURY, FUNDING AND CAPITAL ================= */
    {
      ...
      body:
        "This policy governs the management of maturity and interest rate mismatch between Kritanya's assets and its borrowings. It is owned by the asset liability committee, which meets monthly and on any event that moves the position materially.\n\n" +
    ...
    },
    {
      ...
      body:
        "This document sets out how Kritanya funds itself, the limits on where that funding comes from, and how refinancing risk is managed. Kritanya is not a deposit taking company, so every rupee lent is borrowed and the borrowing book is as much a risk portfolio as the lending book.\n\n" +
        ...
        "Why concentration matters more here than the rate. A lender that funds a fifth of the book has a view on Kritanya's strategy whether or not it exercises it, and a refinancing that must happen on a date is negotiated from a weak position. Diversification is bought with basis points and is worth them.\n\n" +
        "Covenants on borrowings. Kritanya's own borrowings carry covenants: capital adequacy, asset quality, exposure concentration, and in some facilities a restriction on further borrowing without consent. These are monitored on the same calendar as the covenants Kritanya imposes on its wholesale borrowers, and a breach of a borrowing covenant is reported to the Chief Financial Officer and the audit committee immediately. A cross-default clause means a technical breach on one facility can accelerate several.\n\n" +
    ...
    },
    {
      ...
      body:
        "Kritanya transfers portfolios by direct assignment and through securitisation structures, as a funding source and as a capital management tool. This document governs pool selection, retention, servicing and the accounting consequence.\n\n" +
    ...
    /* ================= LEGAL AND ENFORCEMENT ================= */
    {
      ...
      body:
        ...
        "Panel advocates. Proceedings are conducted through empanelled advocates allocated by territory and matter type. Every matter has a named advocate, a named Kritanya officer, a case plan and a next date. An advocate holding a matter with no recorded next date is not managing it.\n\n" +
    ...
    },
    {
      ...
      body:
        ...
        "Service of the notice. Sent to the address recorded in the loan file by a mode that produces evidence of despatch and delivery. Where the notice is returned unclaimed, service is generally taken as effected on the date of return, and the file records the tracking evidence. Sending a notice to an address the borrower has told Kritanya is no longer current is a defect Kritanya created.\n\n" +
    ...
    },
    {
      ...
      body:
        ...
        "Appointment. The arbitrator is appointed by the mechanism the clause provides. Kritanya does not appoint a person with any connection to Kritanya, to the panel advocate conducting the matter, or to the borrower. An award from a proceeding where the appointment can be attacked is an award that will be attacked, and the challenge is heard long after the recovery was needed.\n\n" +
        ...
        "Conciliation and settlement conferences. Kritanya participates in conciliation and in settlement forums, including organised settlement events, where an account is suitable. Suitability means the borrower is contactable, the dispute is about amount or capacity rather than liability, and Kritanya is prepared to settle within a range approved in advance.\n\n" +
    ...
    },
    {
      ...
      body:
        ...
        "Disclosure consequences. Creation, invocation and release of a pledge over the shares of a listed company carry disclosure obligations on the borrower and, in some circumstances, on Kritanya. Every step is cleared with the Company Secretary before it is taken, and the timing is planned around the disclosure rather than the disclosure being handled afterwards.\n\n" +
        "Information held. Kritanya may learn things about a listed borrower through this relationship that are not public. That information is confidential to the deal team, is price sensitive in relation to that borrower's securities, and is handled under the insider information framework. It is never used for any purpose other than the credit decision.\n\n" +
    ...
    },
    {
      ...
      body:
        "Thematic review of document control and the management of customer-facing templates across Kritanya Finserv Limited, conducted November 2025 and reported December 2025.\n\n" +
    ...
    },
    {
      ...
      body:
        "Every measure reported inside Kritanya is defined here. A measure reported without reference to this document is not comparable with anything, and most disagreements about the numbers turn out to be disagreements about the definitions.\n\n" +
    ...
    /* ================= SERVICE, PEOPLE AND CAPITAL MARKETS OPERATIONS ================= */
    {
      ...
      body:
        ...
        "Logging. Logged the same day with a unique reference, the channel, the date of first receipt anywhere in Kritanya, the customer's own words, and the account. The reference is given to the customer at once. The 30 day clock runs from first receipt, not from the date the complaint reached the officer who will answer it, and a complaint forwarded internally does not restart it.\n\n" +
    ...
    },
    {
      ...
      body:
        "This code applies to every employee of Kritanya and both subsidiaries. It sets out the standard expected and what happens when it is not met.\n\n" +
    ...
    },
    {
      ...
      body:
        ...
        "Identification at every visit. The identity card and, where applicable, the authorisation are shown unprompted at the start of every visit. A customer is entitled to refuse a visit from a person who cannot produce both, and to report it, and Kritanya will support the customer in that.\n\n" +
        "Withdrawal of authorisation. Kritanya may withdraw an authorisation at any time without giving a reason, and does so immediately on any conduct allegation pending investigation. Withdrawal pending investigation is a precaution and is not a finding against the person.\n\n" +
    ...
    },
    {
      ...
      body:
        ...
        "Agency staff. Recorded in this register alongside employees, because the obligation to have trained them sits on Kritanya. An agency that cannot produce training records for a person it has deployed has deployed an untrained person on Kritanya's behalf, whatever its own records say.\n\n" +
